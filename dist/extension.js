module.exports = (function (e) {
    ...
    class a extends Error {
      ...
      makePretty() {
        ...
        if ("number" == typeof this.offset) {
          this.range = new i.default(this.offset, this.offset + 1);
          const t = e && (0, s.getLinePos)(this.offset, e);
          if (t) {
        ...
        if (this.linePos) {
          ...
          const r = e && (0, s.getPrettyContext)(this.linePos, e);
          r && (this.message += `:\n\n${r}\n`);
        }
        delete this.source;
      }
  ...
  function (e, t, n) {
    ...
    class r {
      ...
      setOrigRange(e, t) {
        ...
        let s = t;
        for (; s < e.length && !(e[s] > n); ) ++s;
        this.origStart = n + s;
        const i = s;
        for (; s < e.length && !(e[s] >= r); ) ++s;
        return (this.origEnd = r + s), i;
      }
    }
    t.default = r;
  },
  function (e, t, n) {
    const r = n(29),
      { MAX_LENGTH: s, MAX_SAFE_INTEGER: i } = n(28),
      { re: o, t: a } = n(20),
      l = n(30),
      ...
      comparePre(e) {
        ...
        do {
          const n = this.prerelease[t],
            s = e.prerelease[t];
          if ((r("prerelease compare", t, n, s), void 0 === n && void 0 === s))
            return 0;
  ...
  function (e, t, n) {
    ...
    class a {
      ...
      static atDocumentBoundary(e, t, n) {
        ...
        if (n) {
          if (r !== n) return !1;
        } else if (r !== s.Char.DIRECTIVES_END && r !== s.Char.DOCUMENT_END)
          return !1;
        const o = e[t + 1],
          a = e[t + 2];
        if (o !== r || a !== r) return !1;
        ...
        for (; " " === o || "\t" === o || "\n" === o; ) {
          switch (o) {
            case "\n":
              ...
              break;
            case "\t":
              r <= n && (s = !0), (t = a.endOfWhiteSpace(e, t + 2) - 1);
              break;
            case " ":
              (r += 1), (t += 1);
          }
      ...
      get anchor() {
        for (let e = 0; e < this.props.length; ++e) {
          const t = this.getPropValue(e, s.Char.ANCHOR, !0);
          if (null != t) return t;
        }
        return null;
      }
      get comment() {
        ...
        for (let t = 0; t < this.props.length; ++t) {
          const n = this.getPropValue(t, s.Char.COMMENT, !0);
          null != n && e.push(n);
        }
      ...
      get hasComment() {
        if (this.context) {
          ...
          for (let t = 0; t < this.props.length; ++t)
            if (e[this.props[t].start] === s.Char.COMMENT) return !0;
        }
        return !1;
      }
      get hasProps() {
      ...
      get rangeAsLinePos() {
        ...
        const e = (0, i.getLinePos)(this.range.start, this.context.root);
        if (!e) return;
        return {
          start: e,
          end: (0, i.getLinePos)(this.range.end, this.context.root),
        };
      }
      get rawValue() {
      ...
      get tag() {
        for (let e = 0; e < this.props.length; ++e) {
          const t = this.getPropValue(e, s.Char.TAG, !1);
          if (null != t) {
  ...
  function (e, t, n) {
    ...
    class o extends s.default {
      ...
      toJSON(e, t) {
        return t && t.keep ? this.value : (0, r.default)(this.value, e, t);
      }
      toString() {
  ...
  function (e, t, n) {
    ...
    class u extends a.default {
      constructor(e, t = null) {
        super(), (this.key = e), (this.value = t), (this.type = "PAIR");
      }
      get commentBefore() {
      ...
      addToJSMap(e, t) {
        const n = (0, i.default)(this.key, "", e);
        if (t instanceof Map) {
          const r = (0, i.default)(this.value, n, e);
          t.set(n, r);
          ...
          const r = ((e, t, n) =>
            null === t
              ...
              : "object" != typeof t
              ? String(t)
              : e instanceof a.default && n && n.doc
              ? e.toString({
                  anchors: {},
                  doc: n.doc,
                  indent: "",
          ...
          t[r] = (0, i.default)(this.value, r, e);
        }
        return t;
      }
      toJSON(e, t) {
      ...
      toString(e, t, n) {
        ...
        const { simpleKeys: i } = e.doc.options;
        ...
        const f =
            ...
            (!l ||
              u ||
              l instanceof o.default ||
              l.type === s.Type.BLOCK_FOLDED ||
              l.type === s.Type.BLOCK_LITERAL),
          { doc: d, indent: h } = e;
        e = Object.assign({}, e, { implicitKey: !f, indent: h + "  " });
        let p = !1,
          g = d.schema.stringify(
            l,
            e,
            () => (u = null),
            () => (p = !0)
          );
        if (((g = (0, r.default)(g, e.indent, u)), e.allNullValues && !i))
          return (
            this.comment
              ? ((g = (0, r.default)(g, e.indent, this.comment)), t && t())
              : p && !u && n && n(),
            e.inFlow ? g : "? " + g
          );
        (g = f ? `? ${g}\n${h}:` : g + ":"),
        ...
        if (c instanceof a.default) {
          ...
          v = c.comment;
        } else c && "object" == typeof c && (c = d.schema.createNode(c, !0));
        (e.implicitKey = !1), (p = !1);
        const E = d.schema.stringify(
          c,
          e,
          () => (v = null),
          () => (p = !0)
        ...
        let y = " ";
        if (m || this.comment) y = `${m}\n${e.indent}`;
        else if (!f && c instanceof o.default) {
          (("[" === E[0] || "{" === E[0]) && !E.includes("\n")) ||
            (y = "\n" + e.indent);
        }
        return p && !v && n && n(), (0, r.default)(g + y + E, e.indent, v);
      }
    }
    t.default = u;
  },
  ...
  function (e, t, n) {
    class r {
      constructor(e, t) {
        ...
        if (this.set.length > 1) {
          const e = this.set[0];
          if (
            ((this.set = this.set.filter((e) => !p(e[0]))),
            0 === this.set.length)
          )
            this.set = [e];
      ...
      parseRange(e) {
        ...
        const l = r ? c[u.COMPARATORLOOSE] : c[u.COMPARATOR],
          g = e
            ...
            .filter(this.options.loose ? (e) => !!e.match(l) : () => !0)
    ...
    const s = new (n(110))({ max: 1e3 }),
      ...
      m = (e, t) => {
        ...
        let s = r.pop();
        for (; n && r.length; )
          (n = r.every((e) => s.intersects(e, t))), (s = r.pop());
        return n;
      },
      v = (e, t) => (
        a("comp", e, t),
        ...
        return e.replace(n, (n, r, s, i, o, l) => {
          ...
          return (
            ...
            c
              ...
              : u
              ? (n = `>=${s}.0.0${l} <${+s + 1}.0.0-0`)
              : f && (n = `>=${s}.${i}.0${l} <${s}.${+i + 1}.0-0`),
            a("xRange return", n),
            n
          );
        });
      },
      b = (e, t) => (a("replaceStars", e, t), e.trim().replace(c[u.STAR], "")),
      I = (e, t) => (
        a("replaceGTE0", e, t),
        e.trim().replace(c[t.includePrerelease ? u.GTE0PRE : u.GTE0], "")
      ),
      A = (e) => (t, n, r, s, i, o, a, l, c, u, f, d, h) =>
        `${(n = E(r)
          ? ""
          : E(s)
          ? `>=${r}.0.0${e ? "-0" : ""}`
  ...
  function (e, t, n) {
    ...
    class u extends s.default {
      ...
      deleteIn([e, ...t]) {
        ...
        if (n instanceof u) return n.deleteIn(t);
        throw new Error(
      ...
      toString(
        ...
        f && (i += "  ");
        const d = s && this.hasAllNullValues();
        e = Object.assign({}, e, {
          allNullValues: d,
          indent: i,
          inFlow: f,
        ...
        let h = !1,
          p = !1;
        const g = this.items.reduce((t, n, s) => {
          let o;
          n &&
          ...
          return (
            f && !p && a.includes("\n") && (p = !0),
            f && s < this.items.length - 1 && (a += ","),
            (a = (0, r.default)(a, i, o)),
            h && (o || f) && (h = !1),
            t.push({ type: "item", str: a }),
            t
          );
        }, []);
        let m;
        if (0 === g.length) m = n.start + n.end;
        else if (f) {
          ...
          if (
            ...
            r.reduce((e, t) => e + t.length + 2, 2) >
              u.maxFlowStringSingleLineLength
          ) {
            m = e;
            for (const e of r) m += e ? `\n  ${c}${e}` : "\n";
            m += `\n${c}${t}`;
          } else m = `${e} ${r.join(" ")} ${t}`;
        } else {
          const e = g.map(t);
        ...
        return (
          this.comment
            ? ((m += "\n" + this.comment.replace(/^/gm, c + "#")), o && o())
            : h && a && a(),
          m
        );
      }
    }
    (t.default = u), l(u, "maxFlowStringSingleLineLength", 60);
  },
  function (e, t) {
  ...
  function (e, t, n) {
    ...
    function a(e, t) {
      const n = t instanceof i.default ? t.value : t;
      for (const r of e)
    ...
    class l extends r.default {
      add(e) {
        e
          ? e instanceof s.default || (e = new s.default(e.key || e, e.value))
          : (e = new s.default(e));
        if (a(this.items, e.key)) throw new Error(`Key ${e.key} already set`);
        this.items.push(e);
      }
      delete(e) {
      ...
      set(e, t) {
        const n = a(this.items, e);
        n ? (n.value = t) : this.items.push(new s.default(e, t));
      }
      toJSON(e, t, n) {
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = function e(t, n, r) {
        if (Array.isArray(t)) return t.map((t, n) => e(t, String(n), r));
        if (t && "function" == typeof t.toJSON) {
          const e = r && r.anchors && r.anchors.find((e) => e.node === t);
          e &&
            (r.onCreate = (t) => {
              (e.res = t), delete r.onCreate;
            });
          const s = t.toJSON(n, r);
          return e && r.onCreate && r.onCreate(s), s;
        }
        return t;
      });
  },
  ...
  function (e, t, n) {
    ...
    class l extends s.default {
      ...
      toJSON(e, t) {
        ...
        let s = 0;
        for (const e of this.items) n.push((0, r.default)(e, String(s++), t));
        return n;
      }
      toString(e, t, n) {
        return e
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.stringifyString = function (e, t, n, a) {
        ...
        "string" != typeof g &&
          ((g = String(g)), (e = Object.assign({}, e, { value: g })));
        const m = (f) => {
          switch (f) {
            ...
            case s.Type.PLAIN:
              return (function (e, t, n, a) {
                ...
                if (
                  ...
                  return g || v || -1 === h.indexOf("\n")
                    ? -1 !== h.indexOf('"') && -1 === h.indexOf("'")
                      ...
                      : l(h, t)
                    : u(e, t, n, a);
                if (!g && !v && d !== s.Type.PLAIN && -1 !== h.indexOf("\n"))
                  return u(e, t, n, a);
                const y = h.replace(/\n+/g, "$&\n" + m);
                ...
                const O = g
                  ? y
                  : (0, i.default)(y, m, i.FOLD_FLOW, o.strOptions.fold);
                if (
                  f &&
                  !v &&
                  (-1 !== O.indexOf("\n") || -1 !== f.indexOf("\n"))
                )
                  return n && n(), (0, r.addCommentBefore)(O, m, f);
                return O;
              })(e, t, n, a);
            default:
              return null;
        ...
        p !== s.Type.QUOTE_DOUBLE && /[\x00-\x08\x0b-\x1f\x7f-\x9f]/.test(g)
          ? (p = s.Type.QUOTE_DOUBLE)
          : (!d && !h) ||
            (p !== s.Type.BLOCK_FOLDED && p !== s.Type.BLOCK_LITERAL) ||
            (p = s.Type.QUOTE_DOUBLE);
        let v = m(p);
        if (null === v && ((v = m(f)), null === v))
    ...
    function l(e, { implicitKey: t, indent: n }) {
      const { jsonEncoding: r, minMultiLineLength: s } =
          o.strOptions.doubleQuoted,
        a = JSON.stringify(e);
      if (r) return a;
      let l = "",
        c = 0;
      ...
      return (
        (l = c ? l + a.slice(c) : a),
        t ? l : (0, i.default)(l, n, i.FOLD_QUOTED, o.strOptions.fold)
      );
    }
    function c(e, t) {
      ...
      return r ? s : (0, i.default)(s, n, i.FOLD_FLOW, o.strOptions.fold);
    }
    function u({ comment: e, type: t, value: n }, r, a, c) {
      if (/\n[\t ]+$/.test(n) || /^\s*$/.test(n)) return l(n, r);
      const u = r.indent || (r.forceBlockIndent ? " " : ""),
        f = u ? "2" : "1",
        d =
          t !== s.Type.BLOCK_FOLDED &&
          (t === s.Type.BLOCK_LITERAL ||
            !(function (e, t) {
              const n = e.length;
              if (n <= t) return !1;
  ...
  function (e, t, n) {
    ...
    const r = n(6),
      s = n(19);
    (t.FLUTTER_EXECUTABLE_NAME = s.isWin ? "flutter.bat" : "flutter"),
      (t.FLUTTER_PATH = "bin/" + t.FLUTTER_EXECUTABLE_NAME),
      (t.INTL_UTILS = "intl_utils"),
      (t.INTL_UTILS_NOT_NULL_SAFE_MIN_VERSION = "1.0.0"),
      (t.INTL_UTILS_NOT_NULL_SAFE_MAX_VERSION = "2.0.0"),
      (t.INTL_UTILS_NULL_SAFE_MIN_VERSION = "2.0.0"),
      (t.INTL_UTILS_NULL_SAFE_MAX_VERSION = "3.0.0"),
      ...
      (t.EXTENSION_CONFIG_LOCALIZELY_DOWNLOAD_INCLUDE_TAGS =
        "download_include_tags"),
      (t.EXTENSION_CONFIG_LOCALIZELY_DOWNLOAD_EXCLUDE_TAGS =
        "download_exclude_tags"),
      (t.EXTENSION_CONFIG_LOCALIZELY_OTA_ENABLED = "ota_enabled"),
      (t.EXTENSION_CONFIG_API_TOKEN = "api_token"),
      (t.LOCALIZELY_LEARN_MORE_PAGE =
        "https://localizely.com/blog/flutter-localization-step-by-step/?tab=automated-using-flutter-intl&utm_medium=ide_plugin&utm_source=vscode_readmore");
  },
  function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 });
    const r = n(6),
      ...
      i = n(66);
    function o(e) {
      return /^[a-z]{2,3}(_[A-Z][a-z]{3})?(_([A-Z]{2}|[0-9]{3}))?$/.test(e);
    }
    function a(e) {
    ...
    (t.isWin = /^win/.test(process.platform)),
      ...
      (t.validateLocaleCode = function (e) {
        return o(e)
          ? null
          : "Invalid locale code provided. Hint: 'en', 'en_GB', 'zh_Hans_CN'.";
      }),
      ...
      (t.info = function (e) {
        i.getChannel(s.FLUTTER_INTL_CHANNEL).appendLine("INFO: " + e);
      }),
      (t.warning = function (e) {
        i.getChannel(s.FLUTTER_INTL_CHANNEL).appendLine("WARNING: " + e);
      }),
      (t.error = function (e) {
        i.getChannel(s.FLUTTER_INTL_CHANNEL).appendLine("ERROR: " + e);
      });
  },
  function (e, t, n) {
    ...
    const c = (e, t, n) => {
      const r = l++;
      s(r, t), (a[e] = r), (o[r] = t), (i[r] = new RegExp(t, n ? "g" : void 0));
    };
  ...
  function (e, t, n) {
    ...
    e.exports = (e, t) => {
      ...
      if (!(t.loose ? s[i.LOOSE] : s[i.FULL]).test(e)) return null;
      try {
        return new o(e, t);
      } catch (e) {
        return null;
  ...
  function (e, t, n) {
    ...
    var r = n(0);
    const s = { defaultType: r.Type.BLOCK_LITERAL, lineWidth: 76 };
    t.binaryOptions = s;
  ...
  function (e, t, n) {
    ...
    class a extends s.default {
      ...
      parse(e, t) {
        ...
        const { src: n } = e;
        let r = t + 1;
        for (; s.default.atBlank(n, r); ) {
          const e = s.default.endOfWhiteSpace(n, r);
          if ("\n" !== e) break;
          r = e + 1;
        }
        return (this.range = new i.default(t, r)), r;
      }
    }
    t.default = a;
  },
  ...
  function (e, t, n) {
    ...
    class f extends a.default {
      static stringify(
        ...
        if ((!o && i && (o = r.anchors.getName(t) || r.anchors.newName()), o))
          return `*${o}${s ? " " : ""}`;
      ...
      constructor(e) {
        super(), (this.source = e), (this.type = r.Type.ALIAS);
      }
      set tag(e) {
        throw new Error("Alias nodes cannot have tags");
      }
      toJSON(e, t) {
        if (!t) return (0, i.default)(this.source, e, t);
        ...
        if (!o || void 0 === o.res) {
          ...
          throw this.cstNode
            ? new s.YAMLReferenceError(this.cstNode, e)
  ...
  function (e, t, n) {
    ...
    (t.forceWindowsDriveLetterToUppercase = function (e) {
      ...
      (t.isWithinPath = function (e, t) {
        const n = i.relative(t, e);
        return !!n && !n.startsWith("..") && !i.isAbsolute(n);
      }),
      ...
      (t.flatMapAsync = function (e, t) {
        return r(this, void 0, void 0, function* () {
          let n = [];
          for (const r of e) n = n.concat(yield t(r));
          return n;
        });
      }),
      ...
      (t.uriToFilePath = function (e, t = o.isWin) {
        ...
        return (
          e.startsWith("file://")
            ? (n = decodeURI(e.substring(7)))
            : e.startsWith("file:") && (n = decodeURI(e.substring(5))),
          t
            ? ((n = n.replace(/\//g, "\\")),
              "\\" === n[0] && (n = n.substring(1)))
            : "/" !== n[0] && (n = "/" + n),
  ...
  function (e, t, n) {
    ...
    class a extends s.default {
      ...
      parse(e, t) {
        ...
        return (this.range = new i.default(t, n)), n;
      }
    }
    t.default = a;
  },
  function (e, t, n) {
    ...
    var a = [r.default, s.default, i.default];
    t.default = a;
  },
  function (e, t, n) {
    "use strict";
    ...
    var o = {
      createNode: function (e, t, n) {
        ...
        if (t instanceof Map)
          for (const [r, i] of t) s.items.push(e.createPair(r, i, n));
        else if (t && "object" == typeof t)
          for (const r of Object.keys(t))
            s.items.push(e.createPair(r, t[r], n));
        return s;
      },
      default: !0,
      nodeClass: r.default,
      ...
      for (let e = 0; e < n.items.length; ++e) {
        ...
        if (!(o instanceof i.default)) {
          if (o instanceof s.default) {
            ...
            const e = o.items[0] || new i.default();
            o.commentBefore &&
          ...
          n.items[e] = o instanceof i.default ? o : new i.default(o);
        }
      }
      return n;
    }
  ...
  function (e, t, n) {
    ...
    function O() {
      return r(this, void 0, void 0, function* () {
        ...
        const e = [];
        for (const t of s.workspace.workspaceFolders) {
          const n = yield _(t);
          n && e.push(n);
        }
        return e;
    ...
    function _(e) {
      return r(this, void 0, void 0, function* () {
        if (
          (yield s.workspace.fs.readDirectory(e.uri)).some(
            (e) => e[0] === p.PUBSPEC_YAML && e[1] === s.FileType.File
          )
        ) {
          const t = s.Uri.file(i.join(e.uri.fsPath, p.PUBSPEC_YAML)),
            n = yield s.workspace.fs.readFile(t),
            r = new l.TextDecoder(),
          ...
          if (a[p.EXTENSION_CONFIG]) {
            const e = a[p.EXTENSION_CONFIG][p.EXTENSION_CONFIG_ENABLED],
              ...
              s = a[p.EXTENSION_CONFIG][p.EXTENSION_CONFIG_OUTPUT_DIR],
              i =
                a[p.EXTENSION_CONFIG][p.EXTENSION_CONFIG_USE_DEFERRED_LOADING],
              ...
              d = o
                ? o[p.EXTENSION_CONFIG_LOCALIZELY_UPLOAD_OVERWRITE]
                : void 0,
              h = o
                ? o[p.EXTENSION_CONFIG_LOCALIZELY_UPLOAD_AS_REVIEWED]
                : void 0,
              g = o
                ? o[p.EXTENSION_CONFIG_LOCALIZELY_UPLOAD_TAG_ADDED]
                : void 0,
              m = o
                ? o[p.EXTENSION_CONFIG_LOCALIZELY_UPLOAD_TAG_UPDATED]
                : void 0,
              v = o
                ? o[p.EXTENSION_CONFIG_LOCALIZELY_UPLOAD_TAG_REMOVED]
                : void 0,
              E = o
                ? o[p.EXTENSION_CONFIG_LOCALIZELY_DOWNLOAD_EMPTY_AS]
                : void 0,
              y = o
                ? o[p.EXTENSION_CONFIG_LOCALIZELY_DOWNLOAD_INCLUDE_TAGS]
                : void 0,
              O = o
                ? o[p.EXTENSION_CONFIG_LOCALIZELY_DOWNLOAD_EXCLUDE_TAGS]
                : void 0,
              _ = o ? o[p.EXTENSION_CONFIG_LOCALIZELY_OTA_ENABLED] : void 0,
              w = o
                ? new u.LocalizelyConfig(l, c, d, h, g, m, v, E, y, O, _)
                : void 0;
            f = new u.PubspecConfig(e, t, n, r, s, i, w);
          }
          const d = g
            .getModules(e.uri.fsPath)
            .filter((t) => t !== e.uri.fsPath);
    ...
    function w(e) {
      return r(this, void 0, void 0, function* () {
        ...
        const t = e.map((e) => e.getName()),
          n = yield s.window.showQuickPick(t, {
            canPickMany: !1,
    ...
    function L(e) {
      ...
      return r(this, void 0, void 0, function* () {
        if (
          (yield s.workspace.fs.readDirectory(e.root.uri)).some(
            (e) => e[0] === p.PUBSPEC_YAML && e[1] === s.FileType.File
          )
        ) {
          const r = s.Uri.file(i.join(e.getPath(), p.PUBSPEC_YAML)),
            B = yield s.workspace.fs.readFile(r),
            Y = new l.TextEncoder(),
            G = new l.TextDecoder(),
            W = o.parseDocument(G.decode(B), { keepCstNodes: !0 });
          W.set(
            p.EXTENSION_CONFIG,
            Object.assign(
              Object.assign(
                Object.assign(
                    ...
                    Object.assign(
                      ...
                      void 0 !==
                        (null ===
                          ...
                          : u.mainLocale)
                        ? {
                            [p.EXTENSION_CONFIG_MAIN_LOCALE]:
                              e.config.mainLocale,
                          }
                        : {}
                    ),
                  ...
                  void 0 !==
                    (null ===
                      (g =
                        null === (h = e) || void 0 === h ? void 0 : h.config) ||
                    void 0 === g
                      ? void 0
                      : g.outputDir)
                ...
                void 0 !==
                  (null ===
                    (v =
                      null === (m = e) || void 0 === m ? void 0 : m.config) ||
                  void 0 === v
                    ? void 0
                    : v.useDeferredLoading)
                  ? {
                      [p.EXTENSION_CONFIG_USE_DEFERRED_LOADING]:
                        e.config.useDeferredLoading,
                    }
                  : {}
              ),
              void 0 !==
                ...
                void 0 !==
                  (null ===
                    (S =
                      null === (T = e.config) || void 0 === T
                        ? void 0
                        : T.localizelyConfig) || void 0 === S
                    ? void 0
                    : S.otaEnabled)
                ? {
                    [p.EXTENSION_CONFIG_LOCALIZELY]: Object.assign(
                      Object.assign(
                        Object.assign(
                          Object.assign(
                            Object.assign(
                              Object.assign(
                                Object.assign(
                                  Object.assign(
                                    Object.assign(
                                      Object.assign(
                                        Object.assign(
                                          ...
                                          void 0 !==
                                            (null ===
                                              (M = e.config.localizelyConfig) ||
                                            void 0 === M
                                              ? void 0
                                              : M.projectId)
                                            ? {
                                                [p.EXTENSION_CONFIG_LOCALIZELY_PROJECT_ID]:
                                                  e.config.localizelyConfig
                                                    .projectId,
                                              }
                                            : {}
                                        ),
                                        void 0 !==
                                          (null ===
                                            (C = e.config.localizelyConfig) ||
                                          void 0 === C
                                            ? void 0
                                            : C.branch)
                                          ? {
                                              [p.EXTENSION_CONFIG_LOCALIZELY_BRANCH]:
                                                e.config.localizelyConfig
                                                  .branch,
                                            }
                                          : {}
                                      ...
                                      void 0 !==
                                        (null ===
                                          (P = e.config.localizelyConfig) ||
                                        void 0 === P
                                          ? void 0
                                          : P.uploadOverwrite)
                                        ? {
                                            [p.EXTENSION_CONFIG_LOCALIZELY_UPLOAD_OVERWRITE]:
                                              e.config.localizelyConfig
                                                .uploadOverwrite,
                                          }
                                        : {}
                                    ...
                                    void 0 !==
                                      (null ===
                                        (x = e.config.localizelyConfig) ||
                                      void 0 === x
                                        ? void 0
                                        : x.uploadAsReviewed)
                                      ? {
                                          [p.EXTENSION_CONFIG_LOCALIZELY_UPLOAD_AS_REVIEWED]:
                                            e.config.localizelyConfig
                                              .uploadAsReviewed,
                                        }
                                      : {}
                                  ...
                                  void 0 !==
                                    (null === (R = e.config.localizelyConfig) ||
                                    void 0 === R
                                      ? void 0
                                      : R.uploadTagAdded)
                                    ? {
                                        [p.EXTENSION_CONFIG_LOCALIZELY_UPLOAD_TAG_ADDED]:
                                          e.config.localizelyConfig
                                            .uploadTagAdded,
                                      }
                                    : {}
                                ...
                                void 0 !==
                                  (null === (k = e.config.localizelyConfig) ||
                                  void 0 === k
                                    ? void 0
                                    : k.uploadTagUpdated)
                                  ? {
                                      [p.EXTENSION_CONFIG_LOCALIZELY_UPLOAD_TAG_UPDATED]:
                                        e.config.localizelyConfig
                                          .uploadTagUpdated,
                                    }
                                  : {}
                              ...
                              void 0 !==
                                (null === (F = e.config.localizelyConfig) ||
                                void 0 === F
                                  ? void 0
                                  : F.uploadTagRemoved)
                                ? {
                                    [p.EXTENSION_CONFIG_LOCALIZELY_UPLOAD_TAG_REMOVED]:
                                      e.config.localizelyConfig
                                        .uploadTagRemoved,
                                  }
                                : {}
                            ...
                            void 0 !==
                              (null === ($ = e.config.localizelyConfig) ||
                              void 0 === $
                                ? void 0
                                : $.downloadEmptyAs)
                              ? {
                                  [p.EXTENSION_CONFIG_LOCALIZELY_DOWNLOAD_EMPTY_AS]:
                                    e.config.localizelyConfig.downloadEmptyAs,
                                }
                              : {}
                          ),
                          void 0 !==
                            (null === (D = e.config.localizelyConfig) ||
                            void 0 === D
                              ? void 0
                              : D.downloadIncludeTags)
                            ? {
                                [p.EXTENSION_CONFIG_LOCALIZELY_DOWNLOAD_INCLUDE_TAGS]:
                                  e.config.localizelyConfig.downloadIncludeTags,
                              }
                            : {}
                        ),
                        void 0 !==
                          (null === (j = e.config.localizelyConfig) ||
                          void 0 === j
                            ? void 0
                            : j.downloadExcludeTags)
                          ? {
                              [p.EXTENSION_CONFIG_LOCALIZELY_DOWNLOAD_EXCLUDE_TAGS]:
                                e.config.localizelyConfig.downloadExcludeTags,
                            }
                          : {}
                      ),
                      void 0 !==
                        (null === (U = e.config.localizelyConfig) ||
                        void 0 === U
                          ? void 0
                          : U.otaEnabled)
                        ? {
                            [p.EXTENSION_CONFIG_LOCALIZELY_OTA_ENABLED]:
                              e.config.localizelyConfig.otaEnabled,
                          }
                        : {}
                    ),
                  }
            ...
            yield s.workspace.fs.writeFile(r, Y.encode(String(W)));
        }
      });
    }
    function N(...e) {
        ...
        try {
          ...
          if (0 === e.length)
            return void s.window.showErrorMessage(
              "No Flutter projects detected."
            );
          if (!(yield d.getFlutterSdkPath()))
            return void s.window.showErrorMessage("Flutter SDK not available.");
          const t = e.filter((e) => !e.getEnabledConfig()),
            n = yield w(t);
          n &&
            (n.config
              ? (n.config.enabled = !0)
              : (n.config = new u.PubspecConfig(!0)),
            yield L(n),
            m.info(
              `Flutter Intl extension enabled for the '${n.getName()}' project.`
            ),
            E.push(n),
            y && (yield y.generate(n)));
        } catch (e) {
          s.window.showErrorMessage("Failed to initialize project.");
        }
      });
    }
    function b(...e) {
      return r(this, void 0, void 0, function* () {
        try {
          if (!y) return;
          if (0 === E.length)
            return void s.window.showWarningMessage(
              "No Flutter projects with Flutter Intl extension enabled."
            );
          const e = yield w(E);
          if (!e) return;
          const t = yield s.window.showInputBox({
          ...
          s.window.showErrorMessage("Failed to add locale.");
        }
      });
    }
    function I(...e) {
      return r(this, void 0, void 0, function* () {
        try {
          ...
          const t = yield g.getArbFiles(e),
            ...
            r = t
              .map((e) => i.basename(e.fsPath, ".arb").substring(5))
              .filter((e) => m.isValidLocale(e))
              .map((t) => (t === e.getMainLocaleConfig() ? n : t));
          if (0 === r.length)
            return void s.window.showWarningMessage(
              `No locales detected within the '${w.name}' project.`
            );
          const o = yield s.window.showQuickPick(r, {
            canPickMany: !1,
          ...
          if (o === n)
            return void s.window.showWarningMessage(
              "The main locale can't be deleted."
            );
          yield y.removeArbFile(e, o);
        } catch (e) {
          s.window.showErrorMessage("Failed to remove locale.");
        }
      });
    }
    function A(...e) {
      ...
      return r(this, void 0, void 0, function* () {
        try {
          ...
          let r =
              null ===
                (n =
                  null === (t = e.config) || void 0 === t
                    ? void 0
                    : t.localizelyConfig) || void 0 === n
                ? void 0
                : n.projectId,
            i = g.getLocalizelyApiToken();
          if (r && i) {
            const e = "Disconnect from Localizely",
              t = "Update connection config";
            if (
              (yield s.window.showQuickPick([e, t], {
                canPickMany: !1,
                placeHolder: "Already connected to the Localizely",
              })) === e
            )
              return void (yield s.commands.executeCommand(
                "flutterIntl.localizelyDisconnect"
              ));
          }
          if (
            ((r = yield s.window.showInputBox({
              ignoreFocusOut: !0,
          ...
          if (
            ...
            return;
          e.config &&
            (e.config.localizelyConfig = Object.assign(
              Object.assign({}, e.config.localizelyConfig || {}),
              { projectId: r }
            )),
            yield L(e),
            g.updateLocalizelyApiToken(i);
        } catch (e) {
          s.window.showErrorMessage("Failed to connect to Localizely");
        }
      });
    }
    function T(...e) {
      ...
      return r(this, void 0, void 0, function* () {
        try {
          ...
          if (
            ...
            return (yield s.window.showInformationMessage(
              `The '${e.getName()}' project is not connected to the Localizely`,
              t
            )) === t
              ? void s.commands.executeCommand("flutterIntl.localizelyConnect")
              : void 0;
          }
          (null === (i = e.config) || void 0 === i
            ? void 0
            : i.localizelyConfig) &&
            (e.config.localizelyConfig.projectId = void 0),
            yield L(e);
        } catch (e) {
          s.window.showErrorMessage("Failed to disconnect from Localizely");
        }
      });
    }
    function S(...e) {
      return r(this, void 0, void 0, function* () {
        try {
          ...
          s.window.showErrorMessage("Failed to open 'Learn more' page");
        }
      });
    }
    function M(...e) {
      ...
      return r(this, void 0, void 0, function* () {
        try {
          ...
          if (!r || !i) {
            const t = "Connect to Localizely";
            return (yield s.window.showInformationMessage(
              `The project '${e.getName()}' is not connected to the Localizely`,
              t
            )) === t
              ? void s.commands.executeCommand("flutterIntl.localizelyConnect")
              : void 0;
          ...
          if (!o)
            return void s.window.showErrorMessage(
              `Failed to upload main ARB file to Localizely for the '${e.getName()}' project due to a lack of required dependencies.`
            );
          o.isSuccess()
            ? (m.info(o.message), s.window.showInformationMessage(o.message))
            : (m.error(o.message), s.window.showErrorMessage(o.message));
        } catch (e) {
          s.window.showErrorMessage(
            "Failed to upload main ARB file to Localizely"
          );
        }
      });
    }
    function C(...e) {
      ...
      return r(this, void 0, void 0, function* () {
        try {
          ...
          if (!o)
            return void s.window.showErrorMessage(
              `Failed to download ARB files from Localizely for the '${e.getName()}' project due to a lack of required dependencies.`
            );
          o.isSuccess()
            ? (m.info(o.message),
              s.window.showInformationMessage(o.message),
              yield y.generate(e))
            : (m.error(o.message), s.window.showErrorMessage(o.message));
        } catch (e) {
          s.window.showErrorMessage(
            "Failed to download ARB files from Localizely"
          );
        }
      });
    }
    function P(e, t) {
      return r(this, void 0, void 0, function* () {
        try {
          ...
          if (!n) return;
          const r = new s.Range(
              t.start.translate(0, 1),
              t.end.translate(0, -1)
            ),
            i = e.getText(r),
            o = yield s.window.showInputBox({
              value: m.generateStringKeyFromMarkedValue(i),
              placeHolder: "Enter string key",
              validateInput: m.validateStringKey,
            });
          if (!o) return;
          yield g.updateArbFiles(n, o, i),
            yield g.updateDartFile(
              e,
              t,
              `${n.getClassNameConfig()}.of(context).${o}`
            ),
            yield y.generate(n);
        } catch (e) {
          s.window.showErrorMessage(
            "Failed to extract string key to ARB files"
          );
        }
      });
    }
      ...
      return r(this, void 0, void 0, function* () {
        try {
          ...
          if (g.checkIsArbFile(t)) {
            ...
            if (!e) return;
            if (g.checkIsArbFileFromArbDir(e, t)) yield y.generate(e);
            else if (g.checkIsArbFileFromModule(e, t)) {
              const n = e.modules.find((e) => t.startsWith(e));
              if (!n) return;
              if (!v.checkIsExtensionEnabled(n)) return;
              yield y.generateProjectModule(e, n);
            }
          } else if (g.checkIsPubspecFile(t)) {
            const e = (yield O()).find((e) => e.getPath() === i.dirname(t));
            if (e) {
              const t = e.getEnabledConfig(),
                n = E.find((t) => t.getPath() === e.getPath());
              n && !t
                ? ((E = E.filter((t) => t.getPath() !== e.getPath())),
                  m.info(
                    `Flutter Intl extension disabled for the '${e.getName()}' project.`
                  ))
                : n && t
                ? ((n.config = e.config), yield y.generate(n))
                : !n &&
                  t &&
                  (E.push(e),
                  m.info(
                    `Flutter Intl extension enabled for the '${e.getName()}' project.`
                  ),
                  yield y.generate(e));
            }
          }
        } catch (e) {
          s.window.showErrorMessage("Failed to update project on file save.");
        }
      });
    }
    function R(e) {
      return r(this, void 0, void 0, function* () {
        try {
          ...
          for (const t of e.added) {
            const e = yield _(t);
            e && e.getEnabledConfig() && (E.push(e), yield y.generate(e));
          }
          ...
          s.window.showErrorMessage(
            "Failed to update extension on workspace change."
          );
        }
      });
    }
    function k(e) {
      return r(this, void 0, void 0, function* () {
        try {
          ...
          g.checkIsArbDir(n, t) &&
            (m.warning(
              `Enabled extension requires the '${n.getArbDirConfig()}' directory within the '${n.getName()}' project.`
            ),
            yield y.generate(n));
        } catch (e) {
          s.window.showErrorMessage("Failed to generate localization files.");
        }
      });
    }
    function F(e) {
      return r(this, void 0, void 0, function* () {
        try {
          ...
          if (g.checkIsArbFileFromArbDir(n, t)) {
            ...
            if (!e) return;
            if (!v.checkIsExtensionEnabled(e)) return;
        ...
        try {
          ...
          if (g.checkIsArbFileFromArbDir(n, t)) {
            ...
            if (e === n.getMainLocaleConfig()) {
              const t = `intl_${e}.arb`;
              m.warning(
                `Enabled extension requires the '${t}' file within the arb directory of the '${n.getName()}' project.`
              );
            }
            yield y.generate(n);
          } else if (g.checkIsArbFileFromModule(n, t)) {
    ...
    (t.isExtensionEnabledForDocument = function (e) {
      ...
      (t.activate = function (e) {
        return r(this, void 0, void 0, function* () {
          const {
            commands: { registerCommand: t },
            languages: { registerCodeActionsProvider: n },
          } = s;
          try {
            yield (function () {
              return r(this, void 0, void 0, function* () {
                ...
                if (t) {
                  ...
                  for (const t of e) {
                    t.getEnabledConfig() &&
                      (m.info(
                        `Flutter Intl extension enabled for the '${t.getName()}' project.`
                      ),
                      E.push(t));
                  }
                  y = new f.Generator(t);
              ...
              e.subscriptions.push(t("flutterIntl.initialize", N)),
              e.subscriptions.push(t("flutterIntl.addLocale", b)),
                ...
                n(
                  ...
                  new h.ExtractCodeActionProvider(),
                  {
                    providedCodeActionKinds:
                      h.ExtractCodeActionProvider.providedCodeActionKinds,
                  }
                )
              ),
              s.workspace.onDidSaveTextDocument(x),
              s.workspace.onDidChangeWorkspaceFolders(R);
            const i = "**/*";
            s.workspace.createFileSystemWatcher(i, !0, !0, !1).onDidDelete(k);
            const o = "**/intl_*.arb",
              a = s.workspace.createFileSystemWatcher(o, !1, !0, !1);
            a.onDidCreate(F), a.onDidDelete($);
          } catch (e) {
            s.window.showErrorMessage(
              "Failed to activate Flutter Intl extension."
            );
          }
        });
      }),
  ...
  function (e, t, n) {
    ...
    function u(e) {
      let t = e;
      for (; t instanceof i.default; ) t = t.node;
      ...
      for (let e = n - 1; e >= 0; --e) {
        ...
        if (n.type === r.Type.COMMENT) {
          ...
          if (n.type !== r.Type.BLANK_LINE) break;
          s = e;
        }
      }
      if (-1 === s) return null;
    ...
    class f extends a.default {
      static nextContentHasIndent(e, t, n) {
        const r = a.default.endOfLine(e, t) + 1,
          s = e[(t = a.default.endOfWhiteSpace(e, r))];
        return (
          !!s &&
          (t >= r + n ||
            (("#" === s || "\n" === s) && f.nextContentHasIndent(e, t, n)))
        );
      }
      constructor(e) {
      ...
      parse(e, t) {
        ...
        let c = a.default.startOfLine(i, t);
        ...
        let p = t;
        p = a.default.normalizeOffset(i, p);
        let g = i[p],
          m = a.default.endOfWhiteSpace(i, c) === p,
          v = !1;
        for (; g; ) {
          for (; "\n" === g || "#" === g; ) {
            if (m && "\n" === g && !v) {
              ...
              if (p < c + h && !f.nextContentHasIndent(i, p, h)) return p;
              const e = new o.default();
              if (
                ((p = e.parse({ indent: h, lineStart: c, src: i }, p)),
                this.items.push(e),
                (this.valueRange.end = p),
                p >= i.length)
              ) {
            ...
            if (
              ((c = p + 1),
              (p = a.default.endOfIndent(i, c)),
              a.default.atBlank(i, p))
            ) {
              const e = a.default.endOfWhiteSpace(i, p),
                t = i[e];
              (t && "\n" !== t && "#" !== t) || (p = e);
            }
            (g = i[p]), (m = !0);
          ...
          if (
            ...
            (p = a.default.normalizeOffset(i, e.range.end)),
            (g = i[p]),
            (m = !1),
      ...
      toString() {
        ...
        if (null != r) return r;
        let s = e.slice(n.start, t[0].range.start) + String(t[0]);
        ...
        return a.default.addStringTerminator(e, n.end, s);
      }
    }
    t.default = f;
  },
  function (e, t, n) {
    ...
    class c extends o.default {
      ...
      parse(e, t) {
        ...
        for (; "\n" === h || "#" === h; ) {
          if ("#" === h) {
            ...
            g.push(new a.default(d, e)), (d = e);
          } else {
            (c = !0), (u = d + 1);
            "\n" === l[o.default.endOfWhiteSpace(l, u)] &&
              0 === g.length &&
              ((m = new i.default()), (u = m.parse({ src: l }, u))),
              (d = o.default.endOfIndent(l, u));
          }
          h = l[d];
        }
        if (
          (o.default.nextNodeIsIndented(
            h,
            d - (u + f),
            this.type !== r.Type.SEQ_ITEM
          )
          ...
          const e = g[0];
          this.props.push(e), (d = e.end);
        } else d = o.default.endOfLine(l, t + 1);
        const v = this.node ? this.node.valueRange.end : d;
        return (this.valueRange = new a.default(t, v)), d;
      }
      setOrigRanges(e, t) {
        return (
          (t = super.setOrigRanges(e, t)),
      ...
      toString() {
        ...
        return o.default.addStringTerminator(e, n.end, s);
      }
    }
    t.default = c;
  },
    ...
    class o extends r.default {
      ...
      get strValue() {
        ...
        for (let s = e; s < t; ++s) {
          const e = n[s];
          if ("\n" === e) {
            const { fold: e, offset: t } = r.default.foldNewline(n, s, -1);
            (i += e), (s = t);
          } else if (" " === e || "\t" === e) {
            const r = s;
            let o = n[s + 1];
            for (; s < t && (" " === o || "\t" === o); )
              (s += 1), (o = n[s + 1]);
            "\n" !== o && (i += s > r ? n.slice(r, s + 1) : e);
          } else i += e;
        }
        return i;
      }
      parseBlockValue(e) {
        const { indent: t, inFlow: n, src: s } = this.context;
        let i = e,
          a = e;
        for (
          let e = s[i];
          "\n" === e && !r.default.atDocumentBoundary(s, i + 1);
          e = s[i]
        ) {
          const e = r.default.endOfBlockIndent(s, t, i + 1);
          if (null === e || "#" === s[e]) break;
          "\n" === s[e] ? (i = e) : ((a = o.endOfLine(s, e, n)), (i = a));
        }
        return (
      ...
      parse(e, t) {
        this.context = e;
        const { inFlow: n, src: i } = e;
        let a = t;
        const l = i[a];
        return (
          l && "#" !== l && "\n" !== l && (a = o.endOfLine(i, t, n)),
          (this.valueRange = new s.default(t, a)),
          (a = r.default.endOfWhiteSpace(i, a)),
      ...
      constructor(e) {
        if (e instanceof s.default) {
          ...
          t instanceof o.default ||
            ...
            super(e.key, t),
            (this.range = e.range);
        } else super(new i.default("<<"), new o.default());
  ...
  function (e, t, n) {
    ...
    class m {
      constructor({ customTags: e, merge: t, schema: n, tags: s }) {
        if (
          ((this.merge = !!t),
          (this.name = n),
        ...
        if (
          (!e &&
            s &&
            ((e = s), (0, r.warnOptionDeprecation)("tags", "customTags")),
          Array.isArray(e))
        )
          for (const t of e) this.tags = this.tags.concat(t);
        else "function" == typeof e && (this.tags = e(this.tags.slice()));
        for (let e = 0; e < this.tags.length; ++e) {
          const t = this.tags[e];
          if ("string" == typeof t) {
            const n = a.tags[t];
            if (!n) {
              const e = Object.keys(a.tags)
                .map((e) => JSON.stringify(e))
                .join(", ");
      ...
      createNode(e, t, n, r) {
        ...
        r ? (r.wrapScalars = t) : (r = { wrapScalars: t }),
          r.onTagObj && (r.onTagObj(s), delete r.onTagObj);
        const i = {};
        if (e && "object" == typeof e && r.prevObjects) {
          ...
          (i.value = e), r.prevObjects.push(i);
        }
        return (
          (i.node = s.createNode
            ? s.createNode(this, e, r)
            : t
            ? new h.default(e)
            : e),
          i.node
      ...
      createPair(e, t, n) {
        const r = this.createNode(e, n.wrapScalars, null, n),
          s = this.createNode(t, n.wrapScalars, null, n);
        return new d.default(r, s);
      }
      resolveScalar(e, t) {
        t || (t = this.tags);
        for (let n = 0; n < t.length; ++n) {
          const { format: r, test: s, resolve: i } = t[n];
          if (s) {
            const t = e.match(s);
            if (t) {
              let e = i.apply(null, t);
              return (
                e instanceof h.default || (e = new h.default(e)),
                r && (e.format = r),
                e
              );
            }
      ...
      resolveNode(e, t, n) {
        ...
        try {
          if (s) {
            let n = s.resolve(e, t);
            n instanceof u.default || (n = new h.default(n)), (t.resolved = n);
          } else {
            const n = (0, l.resolveString)(e, t);
            "string" == typeof n &&
              r.length > 0 &&
              (t.resolved = this.resolveScalar(n, r));
          }
        } catch (n) {
      ...
      resolveNodeWithFallback(e, t, n) {
        ...
        if (Object.prototype.hasOwnProperty.call(t, "resolved")) return r;
        const o = (({ type: e }) => e === s.Type.FLOW_MAP || e === s.Type.MAP)(
          t
        )
          ? m.defaultTags.MAP
          : (({ type: e }) => e === s.Type.FLOW_SEQ || e === s.Type.SEQ)(t)
          ? m.defaultTags.SEQ
          : m.defaultTags.STR;
        if (o) {
          e.warnings.push(
            new i.YAMLWarning(
              t,
              `The tag ${n} is unavailable, falling back to ${o}`
            )
          );
        ...
        return (
          e.errors.push(
            new i.YAMLReferenceError(t, `The tag ${n} is unavailable`)
          ),
          null
        );
      }
      getTagObject(e) {
        if (e instanceof c.default) return c.default;
        if (e.tag) {
          const t = this.tags.filter((t) => t.tag === e.tag);
          if (t.length > 0) return t.find((t) => t.format === e.format) || t[0];
        }
        let t, n;
        if (e instanceof h.default) {
          ...
          (n = e),
            (t = this.tags.find(
              (e) => e.nodeClass && n instanceof e.nodeClass
            ));
        if (!t) {
      ...
      stringifyProps(e, t, { anchors: n, doc: r }) {
        ...
        return (
          i && ((n[i] = e), s.push("&" + i)),
          e.tag
            ? s.push(r.stringifyTag(e.tag))
            : t.default || s.push(r.stringifyTag(t.tag)),
          s.join(" ")
        );
      }
      stringify(e, t, n, r) {
        ...
        if (((t.tags = this), e instanceof d.default))
          return e.toString(t, n, r);
        s || (s = this.getTagObject(e));
        const i = this.stringifyProps(e, s, t),
          a =
            "function" == typeof s.stringify
              ? s.stringify(e, t, n, r)
              : e instanceof u.default
              ? e.toString(t, n, r)
              : (0, o.stringifyString)(e, t, n, r);
        return i
          ? e instanceof u.default && "{" !== a[0] && "[" !== a[0]
            ? `${i}\n${t.indent}${a}`
            : `${i} ${a}`
          : a;
      }
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.warnOptionDeprecation = function (e, t) {
        ...
        (n += t ? `, use '${t}' instead.` : "."), r(n, "DeprecationWarning");
      });
    const s = {};
  },
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = function (e, t) {
        if (t.type !== r.Type.MAP && t.type !== r.Type.FLOW_MAP) {
          ...
          return e.errors.push(new i.YAMLSyntaxError(t, n)), null;
        }
        const { comments: n, items: d } =
            t.type === r.Type.FLOW_MAP
              ? (function (e, t) {
                  ...
                  for (let d = 0; d < t.items.length; ++d) {
                    (0, c.checkKeyLength)(e.errors, t, d, o, a);
                    const h = t.items[d];
                    if ("string" == typeof h.char) {
                      ...
                      if (":" === n) {
                        if ((void 0 === o && (o = null), ":" === f)) {
                          f = ",";
                          continue;
                        }
                      } else if (
                        (u &&
                          (void 0 === o && "," !== n && (o = null), (u = !1)),
                        void 0 !== o &&
                          (s.push(new l.default(o)),
                          (o = void 0),
                          (a = null),
                          "," === n))
                      ) {
                      ...
                      if ("}" === n) {
                        if (d === t.items.length - 1) continue;
                      } else if (n === f) {
                        f = ":";
                        continue;
                      }
                      const c = "Flow map contains an unexpected " + n,
                        p = new i.YAMLSyntaxError(t, c);
                      (p.offset = r), e.errors.push(p);
                    } else
                      h.type === r.Type.BLANK_LINE
                        ? n.push({ afterKey: !!o, before: s.length })
                        : h.type === r.Type.COMMENT
                        ? n.push({
                            afterKey: !!o,
                            before: s.length,
                            comment: h.comment,
                        ...
                        : ("," !== f &&
                          ...
                          s.push(new l.default(o, e.resolveNode(h))),
                          (o = void 0),
                          (u = !1));
                  }
                  (0, c.checkFlowCollectionEnd)(e.errors, t),
                    void 0 !== o && s.push(new l.default(o));
                  ...
                  for (let f = 0; f < t.items.length; ++f) {
                    ...
                    switch (d.type) {
                      case r.Type.BLANK_LINE:
                        n.push({ afterKey: !!a, before: o.length });
                        break;
                      case r.Type.COMMENT:
                        n.push({
                          afterKey: !!a,
                      ...
                      case r.Type.MAP_VALUE:
                        {
                          if (
                            (void 0 === a && (a = null),
                            d.error && e.errors.push(d.error),
                            !d.context.atLineStart &&
                              d.node &&
                              d.node.type === r.Type.MAP &&
                              !d.node.context.atLineStart)
                          ) {
                            const t =
                              "Nested mappings are not allowed in compact mappings";
                            e.errors.push(new i.YAMLSemanticError(d.node, t));
                          }
                          let n = d.node;
                          if (!n && d.props.length > 0) {
                            (n = new s.default(r.Type.PLAIN, [])),
                              (n.context = { parent: d, src: d.context.src });
                          ...
                          p(d, h),
                            o.push(h),
                            (0, c.checkKeyLength)(e.errors, t, f, a, u),
                            (a = void 0),
                            (u = null);
                        }
                        break;
                      default:
                        ...
                        if (d.valueRangeContainsNewline) {
                          ...
                          e.errors.push(new i.YAMLSemanticError(d, t));
                        }
                    }
                  }
                  void 0 !== a && o.push(new l.default(a));
                  return { comments: n, items: o };
                })(e, t),
          h = new o.default();
        (h.items = d), (0, c.resolveComments)(h, n);
        let g = !1;
        for (let n = 0; n < d.length; ++n) {
          const { key: s } = d[n];
          if (
            (s instanceof f.default && (g = !0),
            e.schema.merge && s && s.value === a.MERGE_KEY)
          ) {
            ...
            s.some((e) => {
              ...
              o && e.errors.push(new i.YAMLSemanticError(t, o));
          } else
            for (let r = n + 1; r < d.length; ++r) {
              ...
              if (
                ...
                const n = `Map keys must be unique; "${s}" is repeated`;
                e.errors.push(new i.YAMLSemanticError(t, n));
                break;
              }
            }
        }
    ...
    function p(e, t) {
      if (
        !(({ context: { lineStart: e, node: t, src: n }, props: s }) => {
          if (0 === s.length) return !1;
          const { start: i } = s[0];
          if (t && i > t.valueRange.start) return !1;
          if (n[i] !== r.Char.COMMENT) return !1;
          for (let t = e; t < i; ++t) if ("\n" === n[t]) return !1;
          return !0;
        })(e)
      )
        return;
      ...
      if (i && i.startsWith(n))
        (t.value.commentBefore = i.substr(n.length + 1)), (s = !0);
      else {
        const r = t.value.comment;
        !e.node &&
          r &&
          r.startsWith(n) &&
          ((t.value.comment = r.substr(n.length + 1)), (s = !0));
      }
      s && (t.comment = n);
    }
  },
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.checkFlowCollectionEnd = function (e, t) {
        ...
        switch (t.type) {
          ...
          default:
            return void e.push(
              new r.YAMLSemanticError(t, "Not a flow collection!?")
            );
        }
        for (let e = t.items.length - 1; e >= 0; --e) {
          const n = t.items[e];
          if (!n || n.type !== s.Type.COMMENT) {
            o = n;
            break;
          }
        }
        if (o && o.char !== n) {
          const s = `Expected ${i} to end with ${n}`;
          let a;
          "number" == typeof o.offset
            ? ((a = new r.YAMLSemanticError(t, s)), (a.offset = o.offset + 1))
            : ((a = new r.YAMLSemanticError(o, s)),
              o.range &&
                o.range.end &&
                (a.offset = o.range.end - o.range.start)),
            e.push(a);
        }
      }),
      (t.checkKeyLength = function (e, t, n, s, i) {
        ...
        if (a > i + 1024) {
          const n = String(s).substr(0, 8) + "..." + String(s).substr(-8);
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = function (e, t) {
        if (t.type !== r.Type.SEQ && t.type !== r.Type.FLOW_SEQ) {
          ...
          return e.errors.push(new s.YAMLSyntaxError(t, n)), null;
        }
        const { comments: n, items: c } =
                  ...
                  for (let d = 0; d < t.items.length; ++d) {
                    ...
                    if ("string" == typeof h.char) {
                      ...
                      if (
                        (":" === n ||
                          (!l && void 0 === c) ||
                          (l && void 0 === c && (c = f ? a.pop() : null),
                          a.push(new i.default(c)),
                          (l = !1),
                          (c = void 0),
                          (u = null)),
                        n === f)
                        ...
                        if ("[" !== f && ":" === n && void 0 === c) {
                          if ("," === f) {
                            if (((c = a.pop()), c instanceof i.default)) {
                              const n =
                                  "Chaining flow sequence pairs is invalid",
                                i = new s.YAMLSemanticError(t, n);
                              (i.offset = r), e.errors.push(i);
                            }
                            l || (0, o.checkKeyLength)(e.errors, t, d, c, u);
                          } else c = null;
                          (u = null), (l = !1), (f = null);
                        } else if (
                          "[" === f ||
                          ...
                          const i = "Flow sequence contains an unexpected " + n,
                            o = new s.YAMLSyntaxError(t, i);
                          (o.offset = r), e.errors.push(o);
                        }
                      } else l = !0;
                    } else if (h.type === r.Type.BLANK_LINE)
                      n.push({ before: a.length });
                    else if (h.type === r.Type.COMMENT)
                      n.push({ comment: h.comment, before: a.length });
                    else {
                      if (f) {
                        const t = `Expected a ${f} in flow sequence`;
                        e.errors.push(new s.YAMLSemanticError(h, t));
                      }
                      const t = e.resolveNode(h);
                      void 0 === c
                        ? a.push(t)
                        : (a.push(new i.default(c, t)), (c = void 0)),
                        (u = h.range.start),
                        (f = ",");
                    }
                  }
                  (0, o.checkFlowCollectionEnd)(e.errors, t),
                    void 0 !== c && a.push(new i.default(c));
                  return { comments: n, items: a };
                })(e, t)
              : (function (e, t) {
                  const n = [],
                    i = [];
                        ...
                        a.error && e.errors.push(a.error),
                          e.errors.push(
                            new s.YAMLSyntaxError(
                              a,
                              `Unexpected ${a.type} node in sequence`
                            )
                          );
                    }
                  }
        ...
        if (
          ((u.items = c),
          (0, o.resolveComments)(u, n),
          !e.options.mapAsMap &&
            c.some((e) => e instanceof i.default && e.key instanceof l.default))
        ) {
          const n =
            "Keys with collection values will be stringified as YAML due to JS Object restrictions. Use mapAsMap: true to avoid this.";
          e.warnings.push(new s.YAMLWarning(t, n));
        }
        return (t.resolved = u), u;
      });
    var r = n(0),
      s = n(1),
      i = c(n(7)),
      ...
      l = {
        ...
        resolve: (e, t) => {
          if ("function" == typeof Buffer) {
            const n = (0, o.resolveString)(e, t);
            return Buffer.from(n, "base64");
          }
          if ("function" == typeof atob) {
            const n = atob((0, o.resolveString)(e, t)),
        ...
        stringify: ({ comment: e, type: t, value: n }, s, o, l) => {
          let c;
          if ("function" == typeof Buffer)
            c =
              n instanceof Buffer
          ...
          if (
            (t || (t = a.binaryOptions.defaultType), t === r.Type.QUOTE_DOUBLE)
          )
            n = c;
          else {
            const { lineWidth: e } = a.binaryOptions,
              ...
              i = new Array(s);
            for (let t = 0, n = 0; t < s; ++t, n += e) i[t] = c.substr(n, e);
            n = i.join(t === r.Type.BLOCK_LITERAL ? "\n" : " ");
          }
          return (0, i.stringifyString)(
            { comment: e, type: t, value: n },
            s,
            o,
            l
          );
  ...
  function (e, t, n) {
    ...
    class d extends l.default {
      constructor() {
        super(),
          f(this, "add", i.default.prototype.add.bind(this)),
          f(this, "delete", i.default.prototype.delete.bind(this)),
          f(this, "get", i.default.prototype.get.bind(this)),
          f(this, "has", i.default.prototype.has.bind(this)),
          f(this, "set", i.default.prototype.set.bind(this)),
          (this.tag = d.tag);
      }
      toJSON(e, t) {
        const n = new Map();
        ...
        for (const e of this.items) {
          ...
          if (
            (e instanceof o.default
              ? ((r = (0, s.default)(e.key, "", t)),
                (i = (0, s.default)(e.value, r, t)))
              : (r = (0, s.default)(e, "", t)),
            n.has(r))
          )
    ...
    (t.YAMLOMap = d), f(d, "tag", "tag:yaml.org,2002:omap");
    var h = {
  ...
  function (e, t, n) {
    ...
    class h extends a.default {
      constructor() {
        super(), (this.tag = h.tag);
      }
      add(e) {
        const t = e instanceof l.default ? e : new l.default(e);
        (0, a.findPair)(this.items, t.key) || this.items.push(t);
      }
      get(e, t) {
        const n = (0, a.findPair)(this.items, e);
        return !t && n instanceof l.default
          ? n.key instanceof u.default
            ? n.key.value
            : n.key
          : n;
      }
      set(e, t) {
        ...
        n && !t
          ...
          : !n && t && this.items.push(new l.default(e));
      }
      toJSON(e, t) {
  ...
  function (e, t, n) {
    ...
    const s = (e, t) => {
      ...
      i = ({ value: e }) => {
        if (isNaN(e) || !isFinite(e)) return (0, r.stringifyNumber)(e);
        let t = "";
        e < 0 && ((t = "-"), (e = Math.abs(e)));
        const n = [e % 60];
        return (
      ...
      o = {
        ...
        resolve: (e, t, n) => s(t, n.replace(/_/g, "")),
        stringify: i,
      };
    t.intTime = o;
    const a = {
    ...
    const l = {
      ...
      resolve: (e, t, n, r, i, o, a, l, c) => {
        l && (l = (l + "00").substr(1, 3));
        let u = Date.UTC(t, n - 1, r, i || 0, o || 0, a || 0, l || 0);
        if (c && "Z" !== c) {
          let e = s(c[0], c.slice(1));
  ...
  function (e, t, n) {
    ...
    const r = n(11),
      s = {};
    function i(e) {
      return s[e] || (s[e] = r.window.createOutputChannel(e)), s[e];
    }
    (t.createChannel = i),
  ...
  function (e, t, n) {
    ...
    function l(e) {
      ...
      return t && i.isValidVersion(t) ? t : null;
    }
    (t.isProjectInNullSafeMode = function (e) {
      return r(this, void 0, void 0, function* () {
        ...
        if (null !== t) {
          const e = l(t);
          if (null !== e) {
            const t = s.minVersion(e);
            if (null !== t)
              return (2 === t.major && t.minor >= 12) || t.major >= 3;
          }
        }
        return !0;
      });
      ...
      (t.getIntlUtilsDependencyVersion = function (e) {
        return r(this, void 0, void 0, function* () {
          const t = yield o.getPubspecFile(e);
          if (!t) return null;
          if (t.dev_dependencies) {
            const e = t.dev_dependencies.intl_utils;
            if (e) return i.isValidVersion(e) ? e : null;
          }
          if (t.dependencies) {
            const e = t.dependencies.intl_utils;
            if (e) return i.isValidVersion(e) ? e : null;
          }
          return null;
        });
      ...
      (t.checkIsExtensionEnabled = function (e) {
        ...
        return (
          t &&
          t[a.EXTENSION_CONFIG] &&
          !0 === t[a.EXTENSION_CONFIG][a.EXTENSION_CONFIG_ENABLED]
        );
      });
  },
  function (e, t, n) {
    ...
    function m(e, t) {
      ...
      return (
        n.endsWith(o.sep) && (n = n.substring(0, n.length - 1)), t.endsWith(n)
      );
    }
    function v(e) {
    ...
    (t.getHomeDirPath = d),
      ...
      (t.updateLocalizelyApiToken = function (e) {
        ...
        if (s.existsSync(t)) {
          const n = new c.TextDecoder(),
            r = new c.TextEncoder(),
            i = s.readFileSync(t),
            o = a.parseDocument(n.decode(i), { keepCstNodes: !0 });
          o.set(u.EXTENSION_CONFIG_API_TOKEN, e),
            s.writeFileSync(t, r.encode(String(o)));
        } else {
          const n = o.dirname(t);
          s.existsSync(n) || s.mkdirSync(n),
            s.writeFileSync(t, `${u.EXTENSION_CONFIG_API_TOKEN}: ${e}`);
        }
      }),
      (t.getArbFiles = p),
      (t.updateArbFiles = function (e, t, n) {
        return r(this, void 0, void 0, function* () {
          ...
          for (let a = 0; a < i.length; a++) {
            const c = yield l.workspace.fs.readFile(i[a]);
            let u;
            try {
              u = JSON.parse(s.decode(c));
            } catch (t) {
              f.warning(
                `Failed to export string key to '${o.basename(
                  i[a].fsPath
                )}' file within the '${e.getName()}' project due to invalid file structure.`
              );
              continue;
            }
            u[t] ||
              ((u[t] = n),
              yield l.workspace.fs.writeFile(
                i[a],
                r.encode(JSON.stringify(u, null, 2))
              ));
          }
        });
      }),
      ...
      (t.updateDartFile = function (e, t, n) {
        ...
        return r.replace(e.uri, t, n), l.workspace.applyEdit(r);
      }),
      (t.checkIsPubspecFile = v),
      (t.getPubspecFile = function (e) {
        return r(this, void 0, void 0, function* () {
          if (
            (yield l.workspace.fs.readDirectory(e.root.uri)).some(
              (e) => e[0] === u.PUBSPEC_YAML && e[1] === l.FileType.File
            )
          ) {
      ...
      (t.getModules = function e(t) {
        ...
        for (let i = 0; i < r.length; i++) {
          ...
          s.lstatSync(l).isDirectory() && !a.startsWith(".") && n.push(...e(l));
        }
        return n;
      });
  },
  function (e, t, n) {
    ...
    (t.fsPath = function (e) {
      return s.forceWindowsDriveLetterToUppercase(
        e instanceof r.Uri ? e.fsPath : e
      );
    }),
      (t.getDartWorkspaceFolders = function () {
        return r.workspace.workspaceFolders
          ? r.workspace.workspaceFolders.filter(i)
          : [];
      }),
      (t.isDartWorkspaceFolder = i);
  },
  function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 });
    ...
    (t.resolvePaths = function (e) {
      if ("string" == typeof e)
        return e.startsWith("~/")
          ? s.join(r.homedir(), e.substr(2))
          : !s.isAbsolute(e) &&
            i.workspace.workspaceFolders &&
            i.workspace.workspaceFolders.length
          ? s.join(o.fsPath(i.workspace.workspaceFolders[0].uri), e)
          : e;
    }),
  ...
  function (e, t, n) {
    ...
    function f(e, t) {
      ...
      if (n.length > 1) {
        ...
        s.errors.unshift(new i.YAMLSemanticError(n[1], e));
      }
      return s;
    }
    var d = {
      createNode: function (e, t = !0, n) {
        ...
        const r = Object.assign({}, s.default.defaults[c.version], c);
      ...
      parse: function (e, t) {
        const n = f(e, t);
        if ((n.warnings.forEach((e) => (0, a.warn)(e)), n.errors.length > 0))
          throw n.errors[0];
        return n.toJSON();
      },
      parseAllDocuments: function (e, t) {
        const n = [];
        let s;
        for (const i of (0, r.default)(e)) {
          const e = new u(t);
          e.parse(i, s), n.push(e), (s = e);
        }
        return n;
      },
      parseCST: r.default,
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = function (e) {
        ...
        -1 !== e.indexOf("\r") &&
          (e = e.replace(
            /\r\n?/g,
            (e, n) => (e.length > 1 && t.push(n), "\n")
          ));
        const n = [];
        let i = 0;
        do {
          const t = new r.default(),
            o = new s.default({ src: e });
          (i = t.parse(o, i)), n.push(t);
        } while (i < e.length);
        return (
          (n.setOrigRanges = () => {
    ...
    class d extends c.default {
      ...
      parseDirectives(e) {
        ...
        for (; !c.default.atDocumentBoundary(t, f, r.Char.DIRECTIVES_END); )
          switch (((f = d.startCommentOrEndBlankLine(t, f)), t[f])) {
            case "\n":
              if (n) {
            ...
            case "#":
              {
                ...
                (f = e.parse({ src: t }, f)), this.directives.push(e), (n = !1);
              }
              break;
            case "%":
              {
                const e = new l.default();
                (f = e.parse({ parent: this, src: t }, f)),
        ...
        return t[f]
          ? ((this.directivesEndMarker = new u.default(f, f + 3)), f + 3)
          : (o
              ? (this.error = new s.YAMLSemanticError(
                  this,
                  "Missing directives-end indicator line"
      ...
      parseContents(e) {
        ...
        let f = c.default.endOfWhiteSpace(n, e),
          h = l === e;
        for (
          this.valueRange = new u.default(f);
          !c.default.atDocumentBoundary(n, f, r.Char.DOCUMENT_END);
          ...
          switch (n[f]) {
            ...
            case "#":
              {
                const e = new a.default();
                (f = e.parse({ src: n }, f)), this.contents.push(e), (h = !1);
              }
              break;
            default: {
              ...
              if (!r) return (this.valueRange.end = e);
              this.contents.push(r), (f = r.range.end), (h = !1);
              const s = (0, o.grabCollectionEndComments)(r);
              s && Array.prototype.push.apply(this.contents, s);
            }
          }
        ...
        if (
          ...
          n[f] &&
            ((this.documentEndMarker = new u.default(f, f + 3)),
            (f += 3),
            n[f]))
        ) {
          if (((f = c.default.endOfWhiteSpace(n, f)), "#" === n[f])) {
            const e = new a.default();
            (f = e.parse({ src: n }, f)), this.contents.push(e);
          }
          switch (n[f]) {
            case "\n":
              f += 1;
      ...
      toString() {
        ...
        return (
          e.length > 0 &&
            ((t.length > 0 || e[0].type === r.Type.COMMENT) && (s += "---\n"),
            (s += e.join(""))),
          "\n" !== s[s.length - 1] && (s += "\n"),
          s
        );
  ...
  function (e, t, n) {
    ...
    class a extends s.default {
      ...
      constructor() {
        super(r.Type.DIRECTIVE), (this.name = null);
      }
      get parameters() {
      ...
      parseParameters(e) {
        ...
        let n = e,
          r = t[n];
        for (; r && "\n" !== r && "#" !== r; ) r = t[(n += 1)];
        return (this.valueRange = new i.default(e, n)), n;
      }
      parse(e, t) {
        this.context = e;
  ...
  function (e, t, n) {
    ...
    class m {
      ...
      constructor(
        ...
        var O, _, w;
        (w = (e, t) => {
          if (u.default.atDocumentBoundary(this.src, t)) return null;
          ...
          switch (v) {
            ...
            default:
              return (
                (y.error = new s.YAMLSyntaxError(
                  y,
                  "Unknown node type: " + JSON.stringify(v)
                )),
          ...
          let O = y.parse(n, E);
          if (
            ((y.range = new p.default(t, O)),
            O <= t &&
              ((y.error = new Error("Node#parse consumed no characters")),
              (y.error.parseEnd = O),
              (y.error.source = y),
              (y.range.end = t + 1)),
            ...
            return (
              (O = e.parse(new m(n), O)), (e.range = new p.default(t, O)), e
            );
          }
          return y;
        }),
          (_ = "parseNode") in (O = this)
      ...
      nodeStartsCollection(e) {
        ...
        return (
          "\n" !== r[s] &&
          "\n" !== r[s - 1] &&
          ((s = u.default.endOfWhiteSpace(r, s)), ":" === r[s])
        );
      }
      parseProps(e) {
        const { inFlow: t, parent: n, src: s } = this,
          i = [];
        let o = !1,
          a = s[(e = u.default.endOfWhiteSpace(s, e))];
        for (
          ;
          a === r.Char.ANCHOR ||
          a === r.Char.COMMENT ||
          ...
          if ("\n" === a) {
            const t = e + 1,
              i = u.default.endOfIndent(s, t),
              a = i - (t + this.indent),
              l = n.type === r.Type.SEQ_ITEM && n.context.atLineStart;
            if (!u.default.nextNodeIsIndented(s[i], a, !l)) break;
            (this.atLineStart = !0), (this.lineStart = t), (o = !1), (e = i);
          } else if (a === r.Char.COMMENT) {
            const t = u.default.endOfLine(s, e + 1);
            i.push(new p.default(e, t)), (e = t);
          } else {
            let t = u.default.endOfIdentifier(s, e + 1);
            a === r.Char.TAG &&
              "," === s[t] &&
              /^[a-zA-Z0-9-]+\.[a-zA-Z0-9-]+,\d\d\d\d(-\d\d){0,2}\/\S/.test(
                s.slice(e + 1, t + 13)
              ) &&
              (t = u.default.endOfIdentifier(s, t + 5)),
              i.push(new p.default(e, t)),
              (o = !0),
              (e = u.default.endOfWhiteSpace(s, t));
          }
          a = s[e];
        }
        o && ":" === a && u.default.atBlank(s, e + 1, !0) && (e -= 1);
        return { props: i, type: m.parseType(s, e, t), valueStart: e };
      }
    }
    t.default = m;
  },
  function (e, t, n) {
    ...
    class o extends r.default {
      parse(e, t) {
        this.context = e;
        const { src: n } = e;
        let i = r.default.endOfIdentifier(n, t + 1);
        return (
          (this.valueRange = new s.default(t + 1, i)),
          (i = r.default.endOfWhiteSpace(n, i)),
  ...
  function (e, t, n) {
    ...
    const a = { CLIP: "CLIP", KEEP: "KEEP", STRIP: "STRIP" };
    t.Chomp = a;
    class l extends s.default {
      constructor(e, t) {
        super(e, t),
      ...
      get strValue() {
        ...
        let d = !0,
          ...
          g = !1;
        for (let n = e; n < t; ++n) {
          for (let e = 0; e < u && " " === i[n]; ++e) n += 1;
          const e = i[n];
          if ("\n" === e) "\n" === p ? (h += "\n") : (p = "\n");
          else {
            const r = s.default.endOfLine(i, n),
              o = i.slice(n, r);
            (n = r),
              f && (" " === e || "\t" === e) && n < c
                ? (" " === p
      ...
      parseBlockValue(e) {
        ...
        for (
          let e = n[r];
          "\n" === e && ((r += 1), !s.default.atDocumentBoundary(n, r));
          e = n[r]
        ) {
          const e = s.default.endOfBlockIndent(n, l, r);
          if (null === e) break;
          if (!this.blockIndent) {
            const s = e - (r + t);
            if ("\n" !== n[e]) {
              ...
              (this.blockIndent = s), (l = t + this.blockIndent - 1);
            } else s > c && (c = s);
          }
          r = "\n" === n[e] ? e : (o = s.default.endOfLine(n, e));
        }
        return (
          this.chomping !== a.KEEP && (r = n[o] ? o + 1 : o),
          (this.valueRange = new i.default(e + 1, r)),
          r
        );
      }
      parse(e, t) {
        ...
        return (
          (r = s.default.endOfWhiteSpace(n, r)),
    ...
    class u extends a.default {
          ...
          switch (f) {
            case "\n":
              ...
              if ("\n" === r[a.default.endOfWhiteSpace(r, u)]) {
                const e = new i.default();
                (u = e.parse({ src: r }, u)), this.items.push(e);
              }
              if (
                ((d = a.default.endOfIndent(r, u)),
                d <= u + c &&
                  ((f = r[d]), d < u + c || ("]" !== f && "}" !== f)))
              ) {
                const e = "Insufficient indentation in flow collection";
                this.error = new s.YAMLSemanticError(this, e);
              }
              break;
            case ",":
              this.items.push({ char: f, offset: d }), (d += 1);
              break;
            case "#":
              {
                const e = new o.default();
                (d = e.parse({ src: r }, d)), this.items.push(e);
              }
              break;
            case "?":
            case ":": {
            ...
            default: {
              ...
              if (!e) return (this.valueRange = new l.default(t, d)), d;
              this.items.push(e),
                (d = a.default.normalizeOffset(r, e.range.end));
            }
          }
          (d = a.default.endOfWhiteSpace(r, d)), (f = r[d]);
        }
        return (
          (this.valueRange = new l.default(t, d + 1)),
          f &&
            (this.items.push({ char: f, offset: d }),
      ...
      setOrigRanges(e, t) {
        return (
          (t = super.setOrigRanges(e, t)),
          this.items.forEach((n) => {
            if (n instanceof a.default) t = n.setOrigRanges(e, t);
      ...
      toString() {
        ...
        if (null != r) return r;
        const s = t.filter((e) => e instanceof a.default);
        let i = "",
          o = n.start;
        return (
          s.forEach((t) => {
    ...
    class a extends s.default {
      ...
      get strValue() {
        ...
        for (let l = t + 1; l < n - 1; ++l) {
          const t = o[l];
          if ("\n" === t) {
            s.default.atDocumentBoundary(o, l + 1) &&
              e.push(
            ...
            switch (((l += 1), o[l])) {
              ...
              case "\t":
                ...
                break;
              case "x":
                (a += this.parseCharCode(l + 1, 2, e)), (l += 2);
                break;
              case "u":
                (a += this.parseCharCode(l + 1, 4, e)), (l += 4);
                break;
              case "U":
                (a += this.parseCharCode(l + 1, 8, e)), (l += 8);
                break;
              case "\n":
                for (; " " === o[l + 1] || "\t" === o[l + 1]; ) l += 1;
                break;
              default:
                e.push(
                  new r.YAMLSyntaxError(
                    this,
                    "Invalid escape sequence " + o.substr(l - 1, 2)
                  )
                ),
                  (a += "\\" + o[l]);
            }
        ...
        return e.length > 0 ? { errors: e, str: a } : a;
      }
      parseCharCode(e, t, n) {
        const { src: s } = this.context,
          i = s.substr(e, t),
          o =
            i.length === t && /^[0-9a-fA-F]+$/.test(i) ? parseInt(i, 16) : NaN;
        return isNaN(o)
          ? (n.push(
              new r.YAMLSyntaxError(
                this,
      ...
      parse(e, t) {
        ...
        return (
          (this.valueRange = new i.default(t, r)),
          (r = s.default.endOfWhiteSpace(n, r)),
          (r = this.parseComment(r)),
          r
        );
  ...
  function (e, t, n) {
    ...
    class m {
      constructor(e) {
        (this.anchors = new s.default(e.anchorPrefix)),
      ...
      deleteIn(e) {
        return (0, u.isEmptyPath)(e)
          ...
          : (this.assertCollectionContents(), this.contents.deleteIn(e));
      }
      getDefaults() {
        return (
          m.defaults[this.version] || m.defaults[this.options.version] || {}
        );
      }
      get(e, t) {
      ...
      getIn(e, t) {
        return (0, u.isEmptyPath)(e)
          ? !t && this.contents instanceof d.default
            ? this.contents.value
            : this.contents
      ...
      hasIn(e) {
        return (0, u.isEmptyPath)(e)
          ...
          : this.contents instanceof u.default && this.contents.hasIn(e);
      }
      set(e, t) {
      ...
      setIn(e, t) {
        (0, u.isEmptyPath)(e)
          ? (this.contents = t)
          : (this.assertCollectionContents(), this.contents.setIn(e, t));
      }
      setSchema(e, t) {
      ...
      parseDirectives(e, t) {
        ...
        if (
          ...
          t &&
            !r &&
            "1.1" === (this.version || t.version || this.options.version))
        ) {
        ...
        switch (
          (e.forEach((e) => {
            if (e.valueRange) {
              ...
              e.type === i.Type.BLANK_LINE &&
                ((r = !0),
                0 === n.length &&
                  t.before.length > 0 &&
                  !this.commentBefore &&
                  ((this.commentBefore = t.before.join("\n")),
                  (t.before = [])));
          }),
          n.length)
        ) {
          ...
          case 1:
            ...
            } else t.after = t.before.concat(t.after);
            break;
          default:
            (this.contents = n),
              this.contents[0]
                ? (this.contents[0].commentBefore = t.before.join("\n") || null)
      ...
      resolveYamlDirective(e) {
        let [t] = e.parameters;
        if (("YAML:1.0" === e.name && (t = "1.0"), this.version)) {
          const t =
        ...
        if (t) {
          if (!m.defaults[t]) {
            const n = `Document will be parsed as YAML ${
      ...
      resolveTagName(e) {
        ...
        let r = !1;
        if (t) {
          const { handle: n, suffix: s, verbatim: i } = t;
          if (i) {
            if ("!" !== i && "!!" !== i) return i;
            ...
            if (t) {
              if (s) {
                ...
                return t.prefix + decodeURIComponent(s);
              }
              this.errors.push(
                new o.YAMLSemanticError(e, `The ${n} tag has no suffix.`)
              );
            } else {
      ...
      resolveNode(e) {
        ...
        const l = { before: [], after: [] },
          u = ((e) =>
            e &&
            [i.Type.MAP_KEY, i.Type.MAP_VALUE, i.Type.SEQ_ITEM].includes(
              e.type
            ))(e.context.parent)
            ...
            case i.Char.COMMENT:
              {
                ...
                const s = e.context.src.slice(t + 1, r),
                  { header: i, valueRange: a } = e;
                a && (t > a.start || (i && t > i.start))
                  ? l.after.push(s)
                  : l.before.push(s);
              }
              break;
        ...
        if (e.type === i.Type.ALIAS) {
          ...
          if (!i) {
            ...
            return n.push(new o.YAMLReferenceError(e, t)), null;
          }
          (f = new c.default(i)), t._cstAliases.push(f);
        } else {
          const t = this.resolveTagName(e);
          if (t) f = r.resolveNodeWithFallback(this, e, t);
          else {
            if (e.type !== i.Type.PLAIN) {
              const t = `Failed to resolve ${e.type} node here`;
              return n.push(new o.YAMLSyntaxError(e, t)), null;
            }
            try {
      ...
      listNonDefaultTags() {
        return (0, a.default)(this.contents).filter(
          (e) => 0 !== e.indexOf(l.default.defaultPrefix)
        );
      }
      setTagPrefix(e, t) {
        if ("!" !== e[0] || "!" !== e[e.length - 1])
      ...
      stringifyTag(e) {
        ...
        }
        {
          ...
          if (!t) return "!" === e[0] ? e : `!<${e}>`;
          const n = e.substr(t.prefix.length).replace(
            /[!,[\]{}]/g,
            (e) =>
              ({
                "!": "%21",
      ...
      toJSON(e) {
        const {
          ...
          s =
            t &&
            ("string" != typeof e || !(this.contents instanceof d.default)),
          i = { doc: this, keep: s, mapAsMap: s && !!n, maxAliasCount: r },
      ...
      toString() {
        ...
        if (this.version) {
          ...
          "yaml-1.1" === this.schema.name &&
            ("1.0" === this.version
              ? (n = "%YAML:1.0")
              : "1.1" === this.version && (n = "%YAML 1.1")),
            e.push(n),
            (t = !0);
        }
        const n = this.listNonDefaultTags();
        this.tagPrefixes.forEach(({ handle: r, prefix: s }) => {
          n.some((e) => 0 === e.indexOf(s)) &&
            (e.push(`%TAG ${r} ${s}`), (t = !0));
        }),
        ...
        const s = { anchors: {}, doc: this, indent: "" };
        let i = !1,
          o = null;
        if (this.contents) {
          ...
          const n = o ? null : () => (i = !0),
            a = this.schema.stringify(this.contents, s, () => (o = null), n);
          e.push((0, r.default)(a, "", o));
        } else
          void 0 !== this.contents &&
            e.push(this.schema.stringify(this.contents, s));
        return (
          this.comment &&
            ((i && !o) || "" === e[e.length - 1] || e.push(""),
    ...
    (t.default = m),
      ...
      (y = {
        "1.0": {
          ...
          merge: !0,
          tagPrefixes: [
            { handle: "!", prefix: l.default.defaultPrefix },
  ...
  function (e, t, n) {
    ...
    class c {
      ...
      createAlias(e, t) {
        return this.setAnchor(e, t), new r.default(e);
      }
      createMergePair(...e) {
        ...
        return (
          (t.value.items = e.map((e) => {
            if (e instanceof r.default) {
              if (e.source instanceof s.default) return e;
            } else if (e instanceof s.default) return this.createAlias(e);
    ...
    const a = (e, t) => {
      if (e && "object" == typeof e) {
        ...
        e instanceof r.default
          ? (n && (t[n] = !0), e.items.forEach((e) => a(e, t)))
          : e instanceof s.default
          ? (a(e.key, t), a(e.value, t))
          : e instanceof i.default && n && (t[n] = !0);
      }
      return t;
    };
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = function (
        ...
        const u = [],
          f = {};
        let d,
          h = i - ("number" == typeof s ? s : t.length),
          p = void 0,
          g = void 0,
          m = !1,
          v = -1;
        "block" === n && ((v = r(e, v)), -1 !== v && (h = v + c));
        for (; (d = e[(v += 1)]); ) {
          if ("quoted" === n && "\\" === d)
            switch (e[v + 1]) {
              case "x":
          ...
          if ("\n" === d)
            "block" === n && (v = r(e, v)), (h = v + c), (p = void 0);
          else {
            if (" " === d && g && " " !== g && "\n" !== g && "\t" !== g) {
              const t = e[v + 1];
              t && " " !== t && "\n" !== t && "\t" !== t && (p = v);
            ...
            if (v >= h)
              if (p) u.push(p), (h = p + c), (p = void 0);
              else if ("quoted" === n) {
                for (; " " === g || "\t" === g; )
                  (g = d), (d = e[(v += 1)]), (m = !0);
                u.push(v - 2), (f[v - 2] = !0), (h = v - 2 + c), (p = void 0);
              } else m = !0;
          }
          g = d;
        }
  ...
  function (e, t, n) {
    ...
    var l = i.default.concat([
      ...
      },
      {
        ...
        stringify: ({ value: e }) =>
          e ? o.boolOptions.trueStr : o.boolOptions.falseStr,
      },
      {
        identify: (e) => "number" == typeof e,
        default: !0,
      ...
      },
      {
        ...
        resolve(e, t) {
          ...
          return (
            t && "0" === t[t.length - 1] && (n.minFractionDigits = t.length), n
          );
        },
        stringify: s.stringifyNumber,
      },
  ...
  function (e, t, n) {
    ...
    const l = [
      ...
      {
        identify: (e) => null == e,
        createNode: (e, t, n) => (n.wrapScalars ? new i.default(null) : null),
        default: !0,
        tag: "tag:yaml.org,2002:null",
        test: /^null$/,
        resolve: () => null,
  ...
  function (e, t, n) {
    ...
    (function (t) {
      ...
      e.exports = async (e, n) => {
        ...
        let r;
        n = { wait: !1, background: !1, ...n };
        let s = [];
        const f = [],
          d = {};
        if (
          (Array.isArray(n.app) && ((s = n.app.slice(1)), (n.app = n.app[0])),
          ...
          if (n.app) r = n.app;
            ...
            let n = !1;
            try {
              await l(u, o.constants.X_OK), (n = !0);
            } catch (e) {}
            r =
          ...
          s.length > 0 && f.push(...s),
            n.wait || ((d.stdio = "ignore"), (d.detached = !0));
        }
        f.push(e),
          "darwin" === process.platform &&
            s.length > 0 &&
            f.push("--args", ...s);
        const h = i.spawn(r, f, d);
        return n.wait
          ? new Promise((e, t) => {
              h.once("error", t),
                h.once("close", (n) => {
  ...
  function (e, t, n) {
    ...
    const r = n(41),
      ...
      i = () => {
        ...
        if (r.release().includes("Microsoft")) return !0;
        try {
          return s.readFileSync("/proc/version", "utf8").includes("Microsoft");
        } catch (e) {
          return !1;
        }
      };
    process.env.__IS_WSL_TEST__ ? (e.exports = i) : (e.exports = i());
  },
  function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 });
    ...
    t.Project = class {
      constructor(e, t, n) {
        (this.root = e), (this.modules = t), (this.config = n);
      }
      getName() {
      ...
      getClassNameConfig() {
        var e;
        const t =
          null === (e = this.config) || void 0 === e ? void 0 : e.className;
        return t && s.isValidClassName(t) ? t : r.DEFAULT_CLASS_NAME;
      }
      getMainLocaleConfig() {
        var e;
        const t =
          null === (e = this.config) || void 0 === e ? void 0 : e.mainLocale;
        return t && s.isValidLocale(t) ? t : r.DEFAULT_MAIN_LOCALE;
      }
      getArbDirConfig() {
        var e;
        const t =
          null === (e = this.config) || void 0 === e ? void 0 : e.arbDir;
        return t && s.isValidPath(t) ? t : r.DEFAULT_ARB_DIR;
      }
    };
  },
  function (e, t, n) {
    ...
    t.LocalizelyConfig = class {
      constructor(e, t, n, r, s, i, o, a, l, c, u) {
        (this.projectId = e),
          ...
          (this.uploadTagAdded = s),
          (this.uploadTagUpdated = i),
  ...
  function (e, t, n) {
    ...
    t.Generator = class {
      constructor(e) {
        this._flutterSdkExePath = d.getFlutterSdkExePath(e);
      }
      createArbFile(e, t) {
        return r(this, void 0, void 0, function* () {
          try {
            const n = e.getPath(),
              r = e.getArbDirConfig(),
              s = i.Uri.file(o.join(n, r, `intl_${t}.arb`));
            a.existsSync(s.fsPath) ||
              (yield i.workspace.fs.writeFile(
                s,
                new l.TextEncoder().encode("{}")
              ));
          } catch (n) {
            throw (
              (d.error(
                `Failed to generate 'intl_${t}.arb' file within '${e.getName()}' project.`
              ),
              n)
            );
          }
        ...
        return r(this, void 0, void 0, function* () {
          try {
            const n = e.getPath(),
              r = e.getArbDirConfig(),
              s = i.Uri.file(o.join(n, r, `intl_${t}.arb`));
            a.existsSync(s.fsPath) && (yield i.workspace.fs.delete(s));
          } catch (n) {
            throw (
              (d.error(
                `Failed to remove 'intl_${t}.arb' file from the '${e.getName()}' project.`
              ),
              n)
            );
          }
      ...
      generateAll(e) {
        return r(this, void 0, void 0, function* () {
          for (const t of e) yield this.generate(t);
        });
      }
      generate(e) {
        return r(this, void 0, void 0, function* () {
          try {
            const t = yield h.getIntlUtilsDependencyVersion(e),
              n = t ? s.parse(d.clearVersion(t)) : null;
            if (!(yield this.checkDependencies(e, n)))
              return void i.window.showErrorMessage(
                `Failed to generate localization files for the '${e.getName()}' project due to a lack of required dependencies.`
              );
            d.info(
              `Generating localization files for the '${e.getName()}' project...`
            );
            const r = e.getPath(),
              o = c.runProcess(
            ...
            u.runProcessInChannel(o, u.getChannel(f.FLUTTER_INTL_CHANNEL));
            // After successful generation, format only generated localization Dart files.
            o.on("close", (code) => {
              if (code === 0) {
                try {
                  ...
                  u.runProcessInChannel(
                    fmt,
                    u.getChannel(f.FLUTTER_INTL_CHANNEL)
                  );
                } catch (err) {
                  u.getChannel(f.FLUTTER_INTL_CHANNEL).appendLine(
                    "dart format failed: " + err
                  );
                }
              }
            });
            ...
            i.window.showErrorMessage(
              `Failed to generate localization files for the "${e.getName()}" project.`
            );
          }
        });
      }
      generateProjectModule(e, t) {
        return r(this, void 0, void 0, function* () {
          const n = o.basename(t);
          try {
            const r = yield h.getIntlUtilsDependencyVersion(e),
              o = r ? s.parse(d.clearVersion(r)) : null;
            if (!(yield this.checkDependencies(e, o)))
              return void i.window.showErrorMessage(
                `Failed to generate localization files for the '${n}' module due to a lack of required dependencies.`
              );
            d.info(`Generating localization files for the '${n}' module...`);
            const a = c.runProcess(
              this._flutterSdkExePath,
              ["pub", "global", "run", "intl_utils:generate"],
              t
            );
            u.runProcessInChannel(a, u.getChannel(f.FLUTTER_INTL_CHANNEL));
            // After successful generation, format only generated localization Dart files for the module.
            a.on("close", (code) => {
              if (code === 0) {
                try {
                  const fmt = c.runProcess(
                    this._flutterSdkExePath,
                    ["format", t + "/lib/generated"],
                    t
                  );
                  u.runProcessInChannel(
                    fmt,
            ...
            i.window.showErrorMessage(
              `Failed to generate localization files for the "${n}" module.`
            );
          }
        });
      }
      uploadMain(e) {
        return r(this, void 0, void 0, function* () {
          const t = yield h.getIntlUtilsDependencyVersion(e),
            n = t ? s.parse(d.clearVersion(t)) : null;
          if (!(yield this.checkDependencies(e, n))) return;
          const o = e.getPath();
          return yield i.window.withProgress(
            ...
            (e, t) =>
              r(this, void 0, void 0, function* () {
                return (
                  e.report({ message: "Uploading to Localizely..." }),
                  new Promise((e) => {
                    const t = [],
                      n = c.runProcess(
                        this._flutterSdkExePath,
                        [
                          ...
                          "global",
                          "run",
                          "intl_utils:localizely_upload_main",
                        ],
                        o
                      );
                    n.stderr &&
                      n.stderr.on("data", (e) => {
                        t.push(new l.TextDecoder().decode(e));
                      }),
                      n.on("close", (n) => {
                        e(
                          new p(
                            n,
                            0 === n
                              ? "Successfully uploaded main ARB file to Localizely"
        ...
        return r(this, void 0, void 0, function* () {
          ...
          return yield i.window.withProgress(
            ...
            (e, t) =>
              r(this, void 0, void 0, function* () {
                return (
                  e.report({ message: "Downloading from Localizely..." }),
                  new Promise((e) => {
                    const t = [],
                      n = c.runProcess(
                        this._flutterSdkExePath,
                        [
                          ...
                          "global",
                          "run",
                          "intl_utils:localizely_download",
                        ],
                        o
                      );
                    n.stderr &&
                        ...
                        this.printErrors(t),
                          e(
                            new p(
                              n,
                              0 === n
                                ? "Successfully downloaded ARB files from Localizely"
                                : this.generateErrorMessage(
                                    t,
                                    "Failed to download ARB files from Localizely"
                                  )
      ...
      printErrors(e) {
        const t = u.getChannel(f.FLUTTER_INTL_CHANNEL);
        let n = !1;
        e.forEach((e) => {
          e.split("\n")
        ...
        for (let t = 0; t < e.length; t++) {
          ...
          if (n)
            try {
              ...
              if (e.errorCode && e.errorMessage) return e.errorMessage;
            } catch (e) {}
        }
        return t;
      }
      checkDependencies(e, t) {
        return r(this, void 0, void 0, function* () {
          const n = yield h.isProjectInNullSafeMode(e),
            o = s.parse(
              n
                ? f.INTL_UTILS_NULL_SAFE_MIN_VERSION
                : f.INTL_UTILS_NOT_NULL_SAFE_MIN_VERSION
            ),
            a = s.parse(
              n
                ? f.INTL_UTILS_NULL_SAFE_MAX_VERSION
                : f.INTL_UTILS_NOT_NULL_SAFE_MAX_VERSION
            );
          if (!o || !a) return !1;
          let l = yield this.checkIsActivatedDependency(f.INTL_UTILS, o, a, t);
          return (
            l ||
              (yield i.window.withProgress(
                {
                  location: i.ProgressLocation.Notification,
                  title: "Flutter Intl",
                  cancellable: !1,
                ...
                (e, n) =>
                  r(this, void 0, void 0, function* () {
                    e.report({ message: "Installing dependencies..." });
                    const n = t ? "" + t : `>=${o} <${a}`;
                    l = yield this.activateGlobalDependency(f.INTL_UTILS, n);
                  })
              )),
            l
          );
      ...
      checkIsActivatedDependency(e, t, n, i) {
        return r(this, void 0, void 0, function* () {
          const r = yield this.getGlobalDependencies();
          return (
            !!r &&
            r.some((r) => {
              if (r.includes(e)) {
      ...
      activateGlobalDependency(e, t) {
        return r(this, void 0, void 0, function* () {
          return new Promise((n) => {
            c.runProcess(this._flutterSdkExePath, [
              "pub",
              "global",
              "activate",
              e,
      ...
      getGlobalDependencies() {
        return r(this, void 0, void 0, function* () {
          return new Promise((e) => {
            const t = new l.TextDecoder();
            let n;
            const r = c.runProcess(this._flutterSdkExePath, [
              "pub",
              "global",
              "list",
            ]);
  ...
  function (e, t, n) {
    ...
    e.exports = (e, t) => {
      if (s(e, t)) return null;
      {
        const n = r(e),
          s = r(t),
          i = n.prerelease.length || s.prerelease.length,
          o = i ? "pre" : "",
          a = i ? "prerelease" : "";
        for (const e in n)
          if (
  ...
  function (e, t, n) {
    ...
    const g = (e, t, n) => {
        ...
        if (r) {
          ...
          if (m(e, t)) {
            if ((E(e, r), !e[a])) return;
          } else n && (e[h] && (r.value.now = Date.now()), e[f].unshiftNode(r));
          return t.value;
        }
      },
      m = (e, t) => {
      ...
      v = (e) => {
        if (e[i] > e[s])
          for (let t = e[f].tail; e[i] > e[s] && null !== t; ) {
            const n = t.prev;
            E(e, t), (t = n);
          }
      },
    ...
    const O = (e, t, n, r) => {
      let s = n.value;
      m(e, s) && (E(e, n), e[a] || (s = void 0)),
        s && t.call(r, s.value, s.key, e);
    };
    e.exports = class {
      constructor(e) {
        if (
      ...
      reset() {
        this[c] &&
          this[f] &&
          this[f].length &&
          this[f].forEach((e) => this[c](e.key, e.value)),
          (this[d] = new Map()),
          (this[f] = new r()),
          (this[i] = 0);
      }
      ...
      set(e, t, n) {
        ...
        const r = n ? Date.now() : 0,
          a = this[o](t, e);
        if (this[d].has(e)) {
          if (a > this[s]) return E(this, this[d].get(e)), !1;
  ...
  function (e, t, n) {
    ...
    (e.exports = r),
      ...
      (r.prototype.reduceReverse = function (e, t) {
        ...
        for (var s = this.length - 1; null !== r; s--)
          (n = e(n, r.value, s)), (r = r.prev);
        return n;
      }),
    ...
    const r = n(9),
      ...
      a = (e, t, n) => {
        ...
        if (1 === e.length && e[0].semver === s)
          return 1 === t.length && t[0].semver === s;
        const r = new Set();
        let a, u, f, d, h, p, g;
        for (const t of e)
        ...
        if (a && u) {
          if (((f = o(a.semver, u.semver, n)), f > 0)) return null;
          if (0 === f && (">=" !== a.operator || "<=" !== u.operator))
            return null;
        }
        for (const e of r) {
          if (a && !i(e, String(a), n)) return null;
          if (u && !i(e, String(u), n)) return null;
          for (const r of t) if (!i(e, String(r), n)) return !1;
          return !0;
        }
        for (const e of t) {
          if (
            ...
            if (">" === e.operator || ">=" === e.operator) {
              if (((d = l(a, e, n)), d === e && d !== a)) return !1;
            } else if (">=" === a.operator && !i(a.semver, String(e), n))
              return !1;
          if (u)
            if ("<" === e.operator || "<=" === e.operator) {
              if (((h = c(u, e, n)), h === e && h !== u)) return !1;
            } else if ("<=" === u.operator && !i(u.semver, String(e), n))
              return !1;
          if (!e.operator && (u || a) && 0 !== f) return !1;
        }
  ...
  function (e, t, n) {
    ...
    const r = n(65);
    function s(e, t, n) {
      const s = t.map((e) => `"${e.replace(/"/g, '\\"')}"`);
      return r.spawn(`"${e}"`, s, { cwd: n, shell: !0 });
    }
    (t.safeSpawn = s),
  ...
  function (e, t, n) {
    ...
    t.getFlutterSdkPath = function () {
      return r(this, void 0, void 0, function* () {
        if (i) return i;
        const e = new s.SdkUtils();
        return (i = yield e.scanWorkspace()), i;
      });
    };
  },
  function (e, t, n) {
    ...
    function p(e) {
      if (e && c.hasPubspec(e)) {
        return new RegExp("sdk\\s*:\\s*flutter", "i").test(
          s.readFileSync(i.join(e, "pubspec.yaml")).toString()
        );
      }
      return !1;
    }
    function g(e) {
      ...
      return (
        t.endsWith("/packages/flutter/lib/") &&
          (t = t.substr(0, t.length - "/packages/flutter/lib/".length)),
        t.endsWith("/") || (t += "/"),
        t.endsWith("/bin/") || (t += "bin/"),
        o.isWin &&
          ((t = t.replace(/\//g, "\\")), "\\" === t[0] && (t = t.substring(1))),
        t
      );
    }
    (t.SdkUtils = class {
      scanWorkspace() {
        return r(this, void 0, void 0, function* () {
          const e = f.getDartWorkspaceFolders().map((e) => e.uri.fsPath),
            ...
            n = process.env.PATH || "",
            r = (t + i.delimiter + n).split(i.delimiter).filter((e) => e);
          let a, l;
          e.forEach(
            (e) =>
              (a =
                ...
                (function (e) {
                  return (function (e, t) {
                    if (e) {
                      ...
                      for (; n; ) {
                        try {
                          if (s.statSync(i.join(n, t)).isDirectory()) return n;
                        } catch (e) {}
                        const e = i.dirname(n);
                        if (n === e) break;
                        n = e;
          ...
          for (const e of m) {
            const t = c.hasPubspec(e) && p(e),
              n = s.existsSync(
                i.join(e, o.FLUTTER_CREATE_PROJECT_TRIGGER_FILE)
              ),
              r =
                s.existsSync(i.join(e, "bin/flutter")) &&
                s.existsSync(i.join(e, "bin/cache/dart-sdk"));
            yield u.resolvedPromise;
            const a = t || n || r;
            l = l || (a ? e : void 0);
          }
          const v = [
              d.config.flutterSdkPath,
              a && i.join(a, "lib/flutter"),
              a && i.join(a, "third_party/dart-pkg/git/flutter"),
              l,
              l && g(i.join(l, ".packages")),
              l && i.join(l, ".flutter"),
              l && i.join(l, "vendor/flutter"),
              process.env.FLUTTER_ROOT,
            ]
              .concat(r)
              .filter(h.notUndefined),
            E = this.findFlutterSdk(v);
          return yield u.resolvedPromise, E;
        });
      }
      findFlutterSdk(e) {
        return this.searchPaths(e, o.flutterExecutableName, (e) =>
          this.hasExecutable(e, o.flutterPath)
        );
      }
      hasExecutable(e, t) {
        const n = i.join(e, t);
        return s.existsSync(n) && s.statSync(n).isFile();
      }
      searchPaths(e, t, n) {
        let r = e
          .filter((e) => e)
        ...
        (r = l.flatMap(r, (e) => {
          return (
            (t = e),
            -1 !== ["bin", "sbin"].indexOf(i.basename(t))
              ? [e]
              : [e, i.join(e, "bin")]
          );
          var t;
        })),
          (r = r.filter((e) => s.existsSync(i.join(e, t)))),
          (r = r.map((e) => {
            const n = i.join(e, t),
              r = e && s.realpathSync(n);
            return i.dirname(i.dirname(r));
          }));
        return r.find(n || ((e) => !0));
      }
    }),
  ...
  function (e, t, n) {
    ...
    t.PackageMap = class {
      constructor(e) {
        ...
        this.localPackageRoot = s.dirname(e);
        const t = r.readFileSync(e, { encoding: "utf8" }).split("\n");
        for (let e of t) {
          if (((e = e.trim()), 0 === e.length || e.startsWith("#"))) continue;
          const t = e.indexOf(":");
          if (-1 !== t) {
            const n = e.substr(0, t),
              r = e.substring(t + 1);
            r.startsWith("file:")
              ? (this.map[n] = o.uriToFilePath(r))
              : ((this.map[n] = s.join(this.localPackageRoot, r)),
                ("lib" !== r && "lib\\" !== r && "lib/" !== r) ||
                  (this.localPackageName = n));
          }
        }
      }
      static findPackagesFile(e) {
        if ("string" == typeof e) return o.findFile(".packages", e);
      }
      get packages() {
      ...
      resolvePackageUri(e) {
        ...
        t = t.substring(0, n);
        const i = this.getPackagePath(t);
        return i ? s.join(i, r) : void 0;
      }
        ...
        if (e)
          for (const n of Object.keys(this.map)) {
            ...
            if (o.isWithinPath(e, r)) {
              if (!t && n === this.localPackageName) return;
              let s = e.substring(r.length);
              return (
                i.isWin && (s = s.replace(/\\/g, "/")),
  ...
  function (e, t, n) {
    ...
    function c(e, t) {
      return r(this, void 0, void 0, function* () {
        ...
        return (yield ((n = e),
        new Promise((e, t) =>
          s.readdir(n, { withFileTypes: !0 }, (n, r) => {
            n ? t(n) : e(r);
          })
        )))
          .filter((e) => e.isDirectory())
          .filter((e) => "bin" !== e.name || (t && t.allowBin))
          .filter((e) => "cache" !== e.name || (t && t.allowCache))
          .map((t) => i.join(e, t.name));
      });
    }
    function u(e) {
      return s.existsSync(i.join(e, "pubspec.yaml"));
    }
    function f(e) {
      return s.existsSync(i.join(e, o.FLUTTER_CREATE_PROJECT_TRIGGER_FILE));
    }
    function d(e) {
      return (
        s.existsSync(i.join(e, "bin/flutter")) &&
        ...
        return r(this, void 0, void 0, function* () {
          const n = yield a.flatMapAsync(e, c),
            ...
            s = e
              ...
              .concat(r)
              .filter((e) =>
                t && t.requirePubspec ? u(e) : u(e) || f(e) || d(e)
              );
          return t && t.sort ? l.sortBy(s, (e) => e.toLowerCase()) : s;
        });
      });
  },
  function (e, t, n) {
  ...
  function (e, t, n) {
    ...
    t.config = new (class {
      ...
      getConfig(e, t) {
        ...
        return i.nullToUndefined(n);
      }
      get flutterSdkPath() {
        return s.resolvePaths(this.getConfig("flutterSdkPath", null));
      }
    })();
  },
  function (e, t, n) {
  ...
  function (e, t, n) {
    ...
    class i {
      provideCodeActions(e, t, n, r) {
        const s = [];
        return (
          this.isCodeActionAvailable(e, t, n) &&
            s.push(this.createExtractToArbCodeAction(e, t)),
          s
        );
      }
      isCodeActionAvailable(e, t, n) {
        if (n && n.only && !r.CodeActionKind.RefactorExtract.contains(n.only))
          return !1;
        if (!s.isExtensionEnabledForDocument(e)) return !1;
        const i = e.getText(t);
        return this.isSelectedString(i);
      }
      isSelectedString(e) {
        return (
          e.length >= 2 &&
    ...
    (t.ExtractCodeActionProvider = i),
      (i.providedCodeActionKinds = [r.CodeActionKind.RefactorExtract]);
  },
]);
